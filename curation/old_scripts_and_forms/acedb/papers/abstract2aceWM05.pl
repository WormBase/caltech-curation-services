...
my @f = </home/acedb/papers/PAPERS/WM/WM05/cnr*.txt>;
my $k = "/home/acedb/papers/PAPERS/WM/WM05/key";
my $outfile = "/home/acedb/papers/out.ace";
foreach $list (@list){
    push @exclusion, </home/acedb/papers/ACEDUMPS/$list.dump.out>;
}
my @directory;
my @file;
...
#	    print "T: $t\n";
    ...
    print OUT "Paper\t\"\[wm2005ab$abs_number\]\"\n";
	...
	print OUT "$print_hash{$abs_word}\t\"$abs_word\"\tInferred_automatically\t\"abstract2aceWM05.pl script, 20030725 - Eimear Kenny\"\n";
    } # foreach my $abs_word (sort keys %print_hash)
    
    print OUT "Abstract\t\"\[wm2005ab$abs_number\]\"\n";   
    print OUT "\n";    
    print OUT "LongText\t:\t\"\[wm2005ab$abs_number\]\"\n";
    print OUT $whole . "\n";		# output the value
...
sub processKey{
	...
	print "1 ABS NUMBER: $absnum\t CNRL NUMBER: $cnrlnum\n";
	$absnum =~ s/^0+//g;
#	$absnum =~ s/[A-C]//g;
