...
my @tables = qw( name publicname synonym summary strain );

my $outfile = '/home/acedb/public_html/karen/hyperlink_dumps/trp_data.txt';
...
foreach my $table (@tables) {
 $result = $dbh->prepare( "SELECT * FROM trp_$table" );
