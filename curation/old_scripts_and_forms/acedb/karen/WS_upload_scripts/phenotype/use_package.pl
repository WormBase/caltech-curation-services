...
my $outfile2 = 'var_phen.ace';
my $molfile = 'mol_phene.ace.' . $date;
my $molfile2 = 'mol_phene.ace' ;
...
open (MO2, ">$molfile2") or die "Cannot create $molfile2 : $!\n";
...
close (MO2) or die "Cannot close $molfile2 : $!";
...
# Karen and J got rid of this because we probably don't need it.  2011 04 28
# `/home/postgres/work/pgpopulation/allele_phenotype/20090514_appnbp/get_recent.pl`;
