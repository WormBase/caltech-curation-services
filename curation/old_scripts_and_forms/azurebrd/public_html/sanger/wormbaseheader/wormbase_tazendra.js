    ...
    function ajaxGet(ajaxPanel, $url, noLoadImg, callback) {
      $jq.ajax({
        ...
        error:function(xhr, textStatus, thrownError){
          ...
          ajaxPanel.html('<div class="ui-state-error ui-corner-all"><p><strong>Sorry!</strong> An error has occured.</p><p><a href="http://www.wormbase.org/tools/support?url=' + location.pathname + '">Let us know</a></p></div>')
        ...
        $jq('.operator').click(function() { 
          if($jq(this).attr("rel")) {
            $jq.post("/rest/livechat?open=1",function() {
              location.href="http://www.wormbase.org/tools/operator";
            });
          }else {
