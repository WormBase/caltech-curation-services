...
# # tried to avoid this error, but didn't help
# # Can't connect to wormbase.org:443 (certificate verify failed)
# # LWP::Protocol::https::Socket: SSL connect attempt failed error:14090086:SSL routines:SSL3_GET_SERVER_CERTIFICATE:certificate verify failed at /usr/local/share/perl/5.18.2/LWP/Protocol/http.pm line 41.
# );

my $directory = '/home/azurebrd/public_html/sanger/wormbaseheader/temp';
...
my $footer = get "https://wormbase.org/footer";
