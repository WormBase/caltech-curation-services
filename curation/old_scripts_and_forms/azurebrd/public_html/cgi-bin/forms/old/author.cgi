...
#
# Updated the path for Ace->connect to WS_current  2002 10 17

$badflag = 0;		# flag if needs to reinput (needs to show form again)
$first = 1;		# flag if first time around (show form for no data)
my $badname = 0;	# flag if name needs to be re-entered
my $bademail = 0;	# flag if email needs to be re-entered
...
# commented out because it stopped working for some reason.  moved the ace
# connection further down into the query section  2002 10 17
# my $db = Ace->connect(-path  =>  '/home/acedb/WS_current',
#                       -program => '/home/acedb/bin/tace') || die "Connection failure: ",Ace->error;

my $data_file = '/home/azurebrd/public_html/cgi-bin/data/author.txt';
my $acefile = "/home/azurebrd/public_html/cgi-bin/data/authors.ace";
...
EndOfText
  ...
  $add4 = "Fax";			# shortcuts for hash
    ...
    # moved the ace connection here since only needed for queries
  my $db = Ace->connect(-path  =>  '/home/acedb/WS_current',
                        -program => '/home/acedb/bin/tace') || die "Connection failure: ",Ace->error;
  ...
  if (scalar(@authors)) { 	# if found
    ...
    print "Please update your information if you recognize your entry.
      ...
      please find out <A HREF=\"http://tazendra.caltech.edu/~azurebrd/cgi-bin/data/labcore.ace\" target=new>here</A>.  <br><br>\n";
  } # if (scalar(@authors))
  ...
  for (my $i = 0; $i < scalar(@authors); $i++) {
    ...
    $ENV{PATH} = untaint($ENV{PATH});	# commented out because no longer using -T
...
<P> See all
<A
HREF="http://tazendra.caltech.edu/~azurebrd/cgi-bin/data/authors.ace">new
submissions</A>.<P>
EndOfText
...
HREF="http://tazendra.caltech.edu/~azurebrd/cgi-bin/data/labcore.ace">here</A>, or leave
...
information.<BR><BR>
<FONT SIZE=+2>If you don't get a verification email, email us at webmaster\@wormbase.org</FONT>
...
please find out 
<A HREF="http://tazendra.caltech.edu/~azurebrd/cgi-bin/data/labcore.ace" target=new>here</A>.
<TR>
...
If you have any problems, questions, or comments, please email <A HREF=\"mailto:cecilia\@tazendra.caltech.edu\">cecilia\@tazendra.caltech.edu</A>
EndOfText
...
sub mail_body {
  my $body = shift;
  my $user = 'author_form_cgi';
  my $email = "cecilia\@tazendra.caltech.edu";
#   my $email = "bounce\@minerva.caltech.edu";
  my $subject = 'author update data';
