...
#
# Changed http://yui. to https://yui-s. for cross origin issue.  2018 12 11
#
# Getting user by IP is not working because of the reverse proxy at WormBase giving everyone the same IP  2022 02 10
#
# Daniela confirms this is not used and can be archived on 2022 02 18
...
#   unless ($fields{person}{field}{person}{termidvalue}{1}) {	 # getting user by IP is not working because of the reverse proxy at WormBase giving everyone the same IP 2022 02 10
...
#   tie %{ $fields{bawm}{field} }, "Tie::IxHash";
#   $fields{bawm}{multi}                                                         = '1';
#   $fields{bawm}{field}{bawm}{type}                                             = 'checkbox';
#   $fields{bawm}{field}{bawm}{label}                                            = 'BAWM contest entry';
#   $fields{bawm}{field}{bawm}{group}                                            = 'bawm';
#   $fields{bawm}{field}{bawm}{mandatory}                                        = 'optional';
#   $fields{bawm}{field}{bawm}{checkboxtext}                                     = qq(BAWM contest entry);
#   $fields{bawm}{field}{bawm}{checkboxvalue}                                    = qq(BAWM contest entry);
...
#   $fields{laboratory}{field}{laboratory}{oamulti}                            = 'multi';
  $fields{laboratory}{field}{laboratory}{ontology_type}                      = 'Laboratory';
...
<link rel="stylesheet" type="text/css" href="https://yui-s.yahooapis.com/2.7.0/build/fonts/fonts-min.css" />
...
<script type="text/javascript" src="https://yui-s.yahooapis.com/2.7.0/build/connection/connection-min.js"></script>
<script type="text/javascript" src="https://yui-s.yahooapis.com/2.7.0/build/datasource/datasource-min.js"></script>
<script type="text/javascript" src="https://yui-s.yahooapis.com/2.7.0/build/autocomplete/autocomplete-min.js"></script>
<script type="text/javascript" src="https://yui-s.yahooapis.com/2.7.0/build/json/json-min.js"></script>
<script type="text/javascript" src="javascript/expr_micropub.js"></script>
