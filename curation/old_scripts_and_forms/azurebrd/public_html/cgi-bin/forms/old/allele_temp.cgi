...
# fields.  2004 02 25
#
# Changed javascript to not have any hidden text boxes because it was making
# Galeon and Mozilla (in linux) crash and IE (windows) wouldn't work.  
# 2004 03 04
...
#       $aceName{lab} = 'Location';
      ...
      $aceName{forward} = 'Forward';
      $aceName{reverse} = 'Reverse';
        ...
        foreach $_ (@all_vars) { 			# for all fields, check for data and output
          ...
          if ($val =~ m/\S/) { 	# if value entered
            ...
            if ($aceName{$var} ne 'NULL') { 
              ...
              elsif ($var eq 'sequence') { $val = uc($val); }	# uppercase sequence
...
function change_type_G(form) {
   ...
   if (sel_idx == 1){
      document.getElementById("mutation").value="eg, Q -> R";
   }
   if (sel_idx == 2){
      document.getElementById("mutation").value="eg, Q -> Amber (Amber[AUG], Ochre[UAA ], Opal[UGA])";
   }   
   if (sel_idx == 3){
...
<center>Please enter as much information as possible. Email <A HREF="mailto:cgc\@wormbase.org">cgc\@wormbase.org</A> for any questions/problems.</center>
<HR>

<form method="post" action="allele_temp.cgi">
 <table width="100%" height="100%" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td colspan="2"><table width="100%" align="center" cellpadding="1" cellspacing="1">
  ...
  <TR>
    ...
    <TD><font size="1">(for contact purpose)</font></TD>
  </TR>
</table>
<tr>
   <td width="50%">
    <table width="99%" height="100%" align="center" cellpadding="1" cellspacing="5" bgcolor="#E8EEEE">
      <tr>
        <td colspan="3"><FONT SIZE=+2><B>GENETIC</B></FONT></td>
      </tr>
      <tr>
        <TD width="39%" ALIGN="right"><B>CGC locus name<br>of gene :</B></TD>
        <td width="32%"><Input Type="Text" Name="gene" Size="37"></td>
        <td width="29%"><font size="1">(if known, eg. aap-1)</font></td>
      </tr>
      <tr>
        <TD ALIGN="left"><B><font color="#336699">Nature of Allele</font></B></TD>
        <TD colspan="3"></TD>
      </tr>
      <tr>
        <td ALIGN="center" colspan="3" align="right"><B>
      ...
      <tr>
        <TD ALIGN="left"><B><font color="#336699">Penetrance</font></B></TD>
        <td colspan="2">&nbsp;</td>
      </tr>
      <tr>
        <td ALIGN="center" colspan="3" align="right"><B>
		      Complete :<Input Type="radio" Name="penetrance" Value="complete">
		      Partial :<Input Type="radio" Name="penetrance" Value="partial"></td>
      </tr>
      <TR>
	  ...
	  <tr>
        <td ALIGN="left" colspan="3"><B><font color="#336699">Temperature Sensitive</font></B></td>
      </tr>
      <TR>
        <TD ALIGN="right"><B>Heat sensitive :</B></TD>
        <TD><Input Type="checkbox" Name="heat_sensitive" Value="heat_sensitive">
            <Input Type="Text" Name="hot_temp" Size="32"></TD>
        <TD><font size="1">(If available. Temp. [Celsius] at which phenotype observed, eg. 12C-15C or 30C)</font></TD>
      </TR>
      <TR>
      ...
      <TR>
        <td ALIGN="left"><B><font color="#336699">Type of mutation</font></B></td>
        <td colspan="2">&nbsp;</td>
      </TR>
      <TR>
      ...
      <TR>
        <TD ALIGN="left"><B><font color="#336699">Species</font></B></TD>
        <TD colspan="2"></TD>
      </TR>
      <tr>
        <td ALIGN="center" colspan="3" align="right"><B>
		  C. elegans :<Input Type="radio" checked Name="species" Value="Caenorhabditis elegans">
          Other : <Input Type="radio" Name="species" Value="other_species">
          <Input Type="Text" Name="species_other" Size="32"></td> </B></td>
      </tr>
    </table>
  </td>
  <td width="50%">
    <table width="99%" height="100%" align="center" cellpadding="1" cellspacing="5" bgcolor="#DCDDE7">
     ...
     <TR>
       ...
       <TD><Input Type="Text" Name="sequence" Size="37"></TD>
       <TD><font size="1">(CDS, eg., B0303.3)</font></TD>
     </TR>
     <tr>
       <td colspan="3"><B><font color="#336699">Type of alteration <font color="#000000" size="1"></font></B><font size=1 color="black">&nbsp;</font></td>
     </tr>
     <TR>
      <td>
     ...
     <TR>
       <TD colspan="3"><B><font color="#336699">Flanking sequences</font></B><font size=1> (necessary to map allele to the genome)</font></TD>
     </TR>
     <TR>
       <TD align="right"><B>Minimum 30 bp upstream :</B></TD>
       <TD><Input Type="Text" Name="upstream" Size="37"></TD>
     </TR>
     <TR>
       <TD align="right"><B>Minimum 30 bp downstream :</B></TD>
       <TD><Input Type="Text" Name="downstream" Size="37"></TD>
     </TR>
     <tr>
       <td ALIGN="left" colspan="3"><B><font color="#336699">Isolation background</font></B></td>
     </tr>
     <TR>
       <TD width="42%" ALIGN="right"><B>Strain :</B></TD>
       <TD width="19%" ALIGN="left"><Input Type="text" Name="strain" Size="37"></TD>
       <TD width="39%"><font size="1">(Identifier of CGC strains, eg, TR1417. If CGC strain, genotype can be omitted)<BR></TD>
     </TR>
     <TR> 
       <TD width="42%" ALIGN="right"><B>Genotype :</B></TD>
       <TD width="19%" ALIGN="left"><Input Type="text" Name="genotype" Size="37"></TD>
       <TD width="39%"><font size="1">(eg, smg-1 (r904) unc-54 (r293) I)</font></td>
     </TR>
     <TR>
       <TD ALIGN="left"><B><font color="#336699">Isolation</font></B></TD>
     </TR>
     <TR>
       <TD align="right"><B>Mutagen :</B></TD>
       <TD><Input Type="Text" Name="mutagen" Size="37"></TD>
       <TD> <font size="1">(eg. EMS, ENU, TMP/UV)</font></TD>
     </TR>
     <TR>
       <TD ALIGN="right"><strong>Forward genetics:</strong></TD>
       <TD><Input Type="Text" Name="forward" Size="37"></TD>
       <TD><font size="1">&nbsp;(standard phenotypic screen)</font></TD>
     </TR>
     <TR>
       <TD ALIGN="right"><strong>Reverse genetics:</strong></TD>
       <TD><Input Type="Text" Name="reverse" Size="37"></TD>
       <TD><font size="1">&nbsp;(directed screen for mutations in a particular gene, using eg, PCR or Tilling) </font></TD>
     </TR>
