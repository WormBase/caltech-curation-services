...
#
# no longer get from spica, get from github.  2020 07 17
...
EndOfText
  ...
  my $url = 'https://raw.githubusercontent.com/obophenotype/c-elegans-phenotype-ontology/master/wbphenotype.obo';
  my $data = get $url;
  print qq($data);
