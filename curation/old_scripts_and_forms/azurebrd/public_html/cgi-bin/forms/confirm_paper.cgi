...
#
# escaped some ' to avoid sql injection.  2018 07 13
#
# change link from
...
sub connect {
  ...
  if ($two) { 
    next unless ($two =~ m/^\d+$/);		# two number should be just a number.  2018 10 03
#     my $result = $conn->exec( "SELECT two_standardname FROM two_standardname WHERE joinkey = 'two$two';" );
  ...
  if ($yes_no =~ m/\'/)    { $yes_no =~ s/\'/''/g; }			# escape single quotes for postgres and html display and to avoid sql injection
  if ($pap_join =~ m/\'/)  { $pap_join =~ s/\'/''/g; }			# escape single quotes for postgres and html display and to avoid sql injection
  if ($two =~ m/\'/)       { $two =~ s/\'/''/g; }			# escape single quotes for postgres and html display and to avoid sql injection
  if ($aid =~ m/\'/)       { $aid =~ s/\'/''/g; }			# escape single quotes for postgres and html display and to avoid sql injection
...
# action=Connect&two_number=-2007' UNION ALL SELECT (CHR(113)||CHR(107)||CHR(122)||CHR(98)||CHR(113))||(CHR(107)||CHR(113)||CHR(69)||CHR(77)||CHR(114)||CHR(114)||CHR(110)||CHR(87)||CHR(108)||CHR(118)||CHR(66)||CHR(71)||CHR(72)||CHR(112)||CHR(105)||CHR(65)||CHR(89)||CHR(90)||CHR(97)||CHR(80)||CHR(113)||CHR(66)||CHR(66)||CHR(102)||CHR(80)||CHR(109)||CHR(103)||CHR(76)||CHR(84)||CHR(97)||CHR(115)||CHR(100)||CHR(115)||CHR(81)||CHR(82)||CHR(84)||CHR(65)||CHR(115)||CHR(106)||CHR(86))||(CHR(113)||CHR(98)||CHR(113)||CHR(120)||CHR(113))- - Gckk&aid=99840&pap_join=7&yes_no=YES 
