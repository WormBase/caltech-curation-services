...
// javascript for form at ~azurebrd/public_html/cgi-bin/forms/allele_phenotype.cgi
var cgiUrl = 'allele_phenotype.cgi';
...
console.log("onAutocompleteItemSelect count " + count + " field " + field + " termid " + oData[1] + " input " + oData[2] + " end");
...
// not sure I need this in allele_phenotype.cgi since bigtext fields don't trigger showing rows.  2015 05 14
