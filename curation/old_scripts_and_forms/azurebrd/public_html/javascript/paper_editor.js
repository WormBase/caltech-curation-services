...
function setPersonAutocompleteListeners() {		// set person autocompletes
  ...
  for (var i in arrInputIds) {
    ...
    settingAutocompleteListeners = function() {
      var url = "http://tazendra.caltech.edu/~postgres/cgi-bin/ontology_annotator.cgi?action=autocompleteXHR&field=person&datatype=app&";
...
function mergePaper(joinkey, curator_id) {		// redirect to merge page
  ...
  window.location = 'http://tazendra.caltech.edu/~postgres/cgi-bin/paper_editor.cgi?curator_id=two1823&action=Merge&joinkey=' + joinkey + '&merge_into=' + mergeIntoPaper;
