...
//
// changed  YAHOO.util.Event.addListener(window, "load", function()  so that when
//   looping through all fields, if it's an ontology field, it adds a listener for
//   clicking the input field, which has the function of calling  
//   asyncTermInfo(field, value)  to populate the obo panel.  2010 12 03
