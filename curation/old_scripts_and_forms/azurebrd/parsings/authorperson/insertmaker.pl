...
my $errorfile = "/home/azurebrd/work/parsings/authorperson/errors/errorfile.insertmaker";
my $insertfile = "/home/azurebrd/work/parsings/authorperson/insertfile.pl";
...
sub readACE {
  local $/ = "";
  my %key_counter;
  my $total = '';		# number of ace entries
  while (<ACE>) { 
