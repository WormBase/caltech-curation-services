...
# Take output from person_lineage form.  Make lines of connection for 1-1
...
# 2003 10 27
#
# This script is for the old form(1) which took data in groups of
# Role instead of person per line and role  2003 10 28
