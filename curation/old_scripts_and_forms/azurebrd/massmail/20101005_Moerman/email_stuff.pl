...
#
# changed for part 2 of Madison / dennis kim.  using 
# "Content-type" => 'text/plain; charset=ISO-8859-1',
# hopefully fully okay now.  2010 05 10
#
# updated for Dan Moerman  mimeAttacher 2010 10 05
...
# $send_to{'2292'}++;		# dhkim@mit.edu  dennis kim
...
sub mimeAttacher {
  ...
  my $user = 'moerman@zoology.ubc.ca';
  my $subject = "WormBase Announcement: Riddle retirement symposium";
  my $attachment = 'riddle_poster_fiinal.pdf';
#   my $attachment = 'Riddle_poster_new_final.pdf';
...
#                                                                                     Jane Mendel
#                                                                                     Editor, WormBook";
  my $body = "Dear Worm Community Member,

As a member of the C. elegans worm community we would like to apprise you of an upcoming event that we think you may find of interest: The Dr. Don Riddle Retirement Symposium on Friday November 5, 2010 at UBC (se attachment for details). Dr. Riddle is retiring at the end of 2010. The symposium will honor Dr. Riddle's numerous scientific contributions to the C. elegans community and includes presentations from a number of renowned speakers, including a few former lab members. Following the symposium will be a dinner banquette on Friday evening (cost per ticket not yet worked out) and on Saturday November 6, a brunch for all current and former Riddle lab members at the Michael Smith lab. This latter event we are hoping some of you will attend and hopefully help Mark Edgley organize. 

Please let us know if you are able to attend the Symposium and/or dinner and, if you are a former lab member,  brunch. We would also like to request any photo's of Don that you can send us (embarrassing is good). If you cannot attend but would like to send a message via email or youtube these will be read/played at the dinner. 

For information on the dinner or symposium please contact Angela Tardif <angelat\@interchange.ubc.ca> 

For information on the Saturday brunch or if you have pictures, messages etc please contact Mark Edgley <edgley\@interchange.ubc.ca> 

Thank you and we look forward to hearing from you. 

WormBase consortium (for The organizing committee - Don Moerman, Mark Edgley and Angela Tardif)";

  $body .= "\n\nPlease note that in the future such announcements may be posted on our blog and/or wiki.  http://blog.wormbase.org/";
...
sub mail_simple {
  ...
  my $user = 'Dennis Kim <dhkim@mit.edu>';
  my $subject = '2010 C. elegans Meeting on Aging, Metabolism, Pathogenesis, Stress, and small RNA, Aug 1 - 4, 2010, Madison, Wisconsin';
  my $body = "Registration and abstract submission website for the 2010 C. elegans
Meeting on Aging, Metabolism, Pathogenesis, Stress, and Small RNAs is
now open.

http://www.union.wisc.edu/ceaging/

Abstract submission deadline is May 24th.
