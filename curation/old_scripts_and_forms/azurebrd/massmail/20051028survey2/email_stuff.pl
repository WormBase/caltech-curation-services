...
#
# Adapted for User Survey email.  2005 10 24
#
# Adapted for Another User Survey email.  2005 10 28
...
sub mimeAttacher {
  ...
  my $subject = 'WormBase Newsletter June 2005';
...
#   my $attachment = 'WormBase_Newsletter_Oct2003.pdf';
  my $body = "The latest issue of the WormBase Newsletter is released, please find it attached to this email.
...
sub mail_body {
  my $email = shift;
  my $user = 'pws@caltech.edu';
  my $subject = 'Gene Ontology survey';
  my $body = "Dear C. elegans colleague,
WormBase is part of the Gene Ontology Consortium.  The Gene Ontology  
(GO) is a system for functional annotation of genes and gene  
products.  It enables classification of gene products according to  
molecular function, biological process, and cellular location of  
action.  The GO is used very often for analysis of large scale  
datasets, but also helps cross-species comparisons.  I ask your help  
in providing them with feedback.
Thanks,
Paul

 From the GO:
The results of this survey will help the us improve our services to  
our user community, and help direct our resources more effectively.

The survey comprises a straightforward set of questions, which should  
take a maximum of 10 minutes to complete. There's no requirement to  
submit your name or email address. To complete the survey, please go to:
