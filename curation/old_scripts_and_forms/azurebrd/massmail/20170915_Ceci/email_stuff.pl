...
#
# send request for help about local meetings to 3 people from each state for Cecilia and Paul.  2017 09 15
...
my $infile = 'ceci_meetings.tsv';
open (IN, "<$infile") or die "Cannot open $infile : $!";
while (my $line = <IN>) {
  chomp $line;
  my ($two, $state, $name, $email, $junk) = split/\t/, $line;
# UNCOMMENT TO EMAIL
#   &mail_simple($name, $email);
} # while (my $line = <IN>)
...
#   $email .= ', closertothewake@gmail.com';
  $email .= ', cecilia@tazendra.caltech.edu';

  my $user = 'Cecilia Nakamura <cecilia@tazendra.caltech.edu>';
  my $subject = "Quick request for information from WormBase";
  my $body = qq(Dear $name:<br/>
<br/>
I am working with WormBase (http://www.wormbase.org) and I'd like to<br/>
ask for your help with information regarding whether there are any local<br/>
<i>C. elegans</i> meetings in your area.<br/>
<br/>
We'd appreciate your help.<br/>
Have a great day!<br/>
<br/>
<br/>
Cecilia Nakamura<br/>
...
Division of Biology and Biological Engineering 156-29<br/>
