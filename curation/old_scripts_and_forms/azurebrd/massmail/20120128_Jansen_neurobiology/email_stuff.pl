...
sub mail_simple {
  ...
  my $user = 'G. Jansen <g.jansen@erasmusmc.nl>';
  my $subject = "June 2012 C. elegans Neurobiology Meeting";
  my $body = "Dear Worm Community,<br/>
<br/>
We are pleased to announce that the 2012 C. elegans Neurobiology Meeting will be held as part of the EMBO Conference Series on C. elegans Biology at the EMBL Advanced Training Centre in Heidelberg, Germany, June 14 - 17.<br/>
<br/>
This year's meeting topics will include:<br/>
   * Development of the nervous system<br/>
   * Behavior<br/>
   * The synapse<br/>
   * Sensory responses<br/>
   * Signaling<br/>
   * New technology<br/>
<br/>
Keynote speakers will include:<br/>
   ...
   * Piali Sengupta<br/>
   * Kang Shen<br/>
In addition, talks and posters will be selected from abstracts.<br/>
<br/>
Please visit the conference website: <a href=\"www.embl.de/training/events/2012/ECE12-01\">www.embl.de/training/events/2012/ECE12-01</a>.<br/>
<br/>
We look forward to welcoming you to Heidelberg, Germany.<br/>
<br/>
Jean-Louis Bessereau, jlbesse\@biologie.ens.fr<br/>
Gert Jansen, g.jansen\@erasmusmc.nl<br/>
William Schafer, wschafer\@mrc-lmb.cam.ac.uk<br/>
<br/>
If you have any questions, please do not hesitate to contact Ruth Hazlewood at the EMBL (ruth.hazlewood\@embl.de)<br /><br />";
  $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
