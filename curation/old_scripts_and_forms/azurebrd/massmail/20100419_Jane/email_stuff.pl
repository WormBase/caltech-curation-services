...
sub mail_simple {
  ...
  my $subject = 'Financial aid for 2010 C. elegans Development and Gene expression meeting';
  my $body = "Dear Worm Breeders,

We are writing to let you know that there is a significant amount of
financial aid available for C. elegans Development and Gene
expression topic meeting in Heidelberg 17-20 June.  This is mostly in
the form of registration fee waivers, but we will also be able to
provide some travel awards.

The application for financial aid is on the abstract submission page
of the meeting. Instructions for abstract submission are given in
your registration confirmation email.  The process is described at
the bottom of the Registration and payment tab.  So we encourage
students, post-docs and PIs to attend and present their latest
results! It's going to be a great meeting!

Remember, registration and abstract submission deadline is April 12th.
...
Julie Ahringer, Michel Labouesse, and Iain Mattaj";
  $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
