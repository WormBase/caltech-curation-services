...
sub mail_simple {
  ...
  my $user = 'Martha Soto <sotomc@umdnj.edu>';
  my $subject = "June 2012 C. elegans Development Meeting";
  my $body = "Dear Worm Community,<br />
<br />
We are pleased to announce that the 2012 C. elegans Development, Cell Biology, and Gene Expression Meeting will be held on the campus of the University of Wisconsin-Madison, June 7-10. <br />
<br />
<a href=\"http://www.union.wisc.edu/celegans/index2012.html\">http://www.union.wisc.edu/celegans/index2012.html</a><br />
<br />
Topics represented at the meeting will include:  <br />
Cell Biology, Cell Cycle and Cytokinesis, Cell Death, Cell Fate, Cell Polarity, <br />
Emerging Technologies, Gametogenesis, Gene Regulation during Development, <br />
Germline Development, Meiosis, Morphogenesis, Cell Adhesion & Migration, and Sex Determination.<br />
<br />
In addition to posters and talks selected from the Abstracts, <br />
the meeting will feature an exciting set of Keynote Speakers:<br />
<br />
Julie Ahringer (Gurdon Institute, University of Cambridge) <br />
David Greenstein (University of Minnesota) <br />
Ken Kemphues (Cornell University)<br />
Craig Mello (University of Massachusetts Medical School, HHMI)<br />
Karen Oegema (University of California  - San Diego)  <br />
Shai Shaham (The Rockefeller University)<br />
Anne Villeneuve (Stanford University)<br />
<br />
Information on abstract submission, registration, and travel assistance for students and postdocs will be added to the website in early 2012. <br />
<br />
Please join us in Madison!<br />
<br />
E. Jane Hubbard &lt;jane.hubbard\@med.nyu.edu><br />
Jeremy Nance &lt;jeremy.nance\@med.nyu.edu><br />
Martha Soto &lt;sotomc\@umdnj.edu><br /><br />";
  $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
