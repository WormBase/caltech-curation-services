...
sub mail_simple {
  ...
  my $body = "Dear Worm Researchers,<br/><br/>

It is once again time to submit articles for the next issue of the Worm Breeder's Gazette. The next deadline is August 1, 2011: the issue will be available mid August. It would be particularly appropriate for this issue if you would submit any new methods you described during the 18th International <i>C. elegans</i> Meeting.<br/><br/>

Author instructions can be found at http://www.wormbook.org/wbg/instructions-for-authors/, where you will also find a link to our online submission form and a brief tutorial on how to use the form. Once you have logged in, you can submit an article by clicking 'Add New' under the 'Articles' tab in the left sidebar. You can save a draft and work on it at a later date. Before you submit your article, please make sure to check it using the 'Preview' button. This will ensure that you have included all the required information and that your article meets our length limitation.<br/><br/>

If you would like to submit artwork for consideration as a Worm Breeder's Gazette cover, please format your work as a 600 dpi TIFF with an 8.5 x 11 inch ratio and email it to me (Jane Mendel mendelj\@caltech.edu).<br/><br/>

If you have any questions, please don't hesitate to contact me.<br/><br/>

We look forward to receiving your contribution to the Worm Breeder's Gazette.<br/><br/>
