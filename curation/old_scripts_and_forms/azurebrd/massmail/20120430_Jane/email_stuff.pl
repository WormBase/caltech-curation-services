...
#
# another announcement, 2011 04 30
...
sub mail_simple {
  ...
  my $subject = "The Worm Breeder's Gazette reminder";
  my $body = qq( Dear Worm Researchers,<br/>
<br/>
It is once again time to submit content for the next issue of the Worm Breeder's Gazette. The next deadline is Monday, June 4, 2012; the issue will be available mid June.<br/>
<br/>
Your contribution does not have to be limited to research articles and methods.  The WormBreeder's Gazette is also a place to communicate any appropriate information, such as announcements and editorial comments, to the Worm community. <br/>
<br/>
Author instructions can be found at <a href="http://www.wormbook.org/wbg/instructions-for-authors/">http://www.wormbook.org/wbg/instructions-for-authors/</a>, where you will also find a link to our online submission form and a brief tutorial on how to use the form.  Once you have logged in, you can submit an article by clicking 'Add New' under the 'Articles' tab in the left sidebar. You can save a draft and work on it at a later date. Before you submit your article, please make sure to check it using the 'Preview' button.  This will ensure that you have included all the required information and that your article meets our length limitation.<br/>
<br/>
If you would like to submit artwork for consideration as a Worm Breeder's Gazette cover, please format your work as a 600 dpi TIFF with an 8.5 x 11 inch ratio and email it to me (Jane Mendel mendelj\@caltech.edu).<br/>
<br/>
If you have any questions about the WormBreeder's Gazette or WormBook, please don't hesitate to contact me directly or via <a href="http://www.wormbook.org/db/misc/feedback.cgi">http://www.wormbook.org/db/misc/feedback.cgi</a>.<br/>
<br/>
Thank you for your interest in The WormBreeder's Gazette,<br/>
<br/>
<br/>
Jane Mendel<br/>
<br/>
