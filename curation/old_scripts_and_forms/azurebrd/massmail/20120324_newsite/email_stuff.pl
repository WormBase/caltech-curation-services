...
#
# notify everyone about new website for Paul and Ranjana.  2012 03 24
...
sub mail_simple {
  ...
  my $user = 'Paul Sternberg <pws@caltech.edu>';
  my $subject = "WormBase switching to new website, March 30th";
  my $body = "Dear worm community member,<br />
<br />
WormBase will switch to the new website on March 30th. We understand that it may take some time to adjust to the new interface, but hope that the improved organization, customizability, and speed of the site will ease the transition. Once the new website is released, the current (old) website will be frozen at version WS230 and made available for the foreseeable future, at <a href=\"legacy.wormbase.org\">legacy.wormbase.org</a>. We will continue to refine and expand the new site with exciting new features throughout 2012. As always, we welcome all comments and suggestions at help\@wormbase.org.<br />
<br />
The WormBase Consortium<br /><br />";
  $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
