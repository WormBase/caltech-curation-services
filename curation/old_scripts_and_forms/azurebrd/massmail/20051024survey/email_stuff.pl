...
sub mail_body {
  my $email = shift;
  my $user = 'pws@caltech.edu';
  my $subject = 'WormBase online survey';
  my $body = "Dear C. elegans researcher:
In preparation for our annual meeting with our Advisory Board  
(Jonathan Hodgkin, Tim Schedl, Marty Chalfie, and Cori Bargmann among  
others), we are conducting a survey about WormBase to help prioritize  
the next year's work.  Please help us by taking a few minutes to  
complete the survey, which is located at

http://www.wormbase.org/db/misc/2005_survey

or accessible from the top of the WormBase home page.
