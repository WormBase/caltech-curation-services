...
#
# changed for subscription to WormBook and Worm Breeder's Gazette.  2012 11 28
# finally run on 2012 12 11
#
# special one-time announcement for Jane and Todd for Worm Breeder's Gazette.  
# sent from mangolassi.  2016 04 26
...
#   $email .= ', closertothewake@gmail.com';
  ...
  my $subject = "Worm Breeder's Gazette Announcement";
  my $body = qq(
Dear Worm Breeders --<br/>
<br/>
We are pleased to announce the next iteration of the Worm Breeder's Gazette with some exciting new changes.<br/>
<br/>
Starting today, the Gazette will publish articles on a rolling basis with only a brief editorial period to review formatting. We've also made the submission process simpler and more robust. For example, you can start a submission online, saving your progress at any time to complete later.<br/>
<br/>
By accelerating the availability of Gazette articles, we seek to preserve the original spirit of the Gazette: publication of breaking results and new methods of general interest to the community in a brief and digestible format. Submissions will still be restricted to approximately one printed page with notable exceptions for the inclusion of rich media such as images and movies.<br/>
<br/>
We look forward to your contributions!<br/>
<br/>
-- The Worm Breeder's Gazette Editors, Jane Mendel and Todd Harris<br/>
<br/>
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~<br/>
<br/>
To participate in the new version of the Gazette, first register for an account.<br/>
<br/>
    <a href="http://wbg.wormbook.org/register/">http://wbg.wormbook.org/register/</a><br/>
<br/>
Once registered, you will be able to submit an article online:<br/>
<br/>
   <a href="http://wbg.wormbook.org/submit-new-article/">http://wbg.wormbook.org/submit-new-article/</a><br/>
<br/>
If you've participated in the past, you will need to reset your password first:<br/>
<br/>
  <a href="http://wbg.wormbook.org/reset-password/">http://wbg.wormbook.org/reset-password/</a><br/>
<br/>
Subscribe by email:<br/>
<br/>
   <a href="http://feedburner.google.com/fb/a/mailverify?uri=thewormbreedersgazette">http://feedburner.google.com/fb/a/mailverify?uri=thewormbreedersgazette</a><br/>
<br/>
Follow us on Twitter:<br/>
<br/>
   <a href="https://twitter.com/wormbreeders">https://twitter.com/wormbreeders</a><br/>);
#   $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
