...
#
# changed for everyone for Gert Jansen for Neurobiology meeting.  2012 01 28
#
# changed for Malene Hansen for Aging and other stuff meeting.  2012 03 10
...
# $send_to{'2242'}++;		# malene hansen
# $send_to{'3965'}++;		# emily troemel
# $send_to{'291'}++;		# gert jansen
...
sub mail_simple {
  ...
  my $user = 'Malene Hansen <mhansen@sanfordburnham.org>';
  my $subject = "July 2012 C. elegans topic meeting on Aging/Metabolism/Stress/Pathogenesis/Small RNAs";
  my $body = "Dear Worm Community,<br/>
<br/>
We are pleased to announce that the 2012 <i>C. elegans</i> topic meeting on Aging, Metabolism, Stress, Pathogenesis, and Small RNAs will be held at the <b>University of Wisconsin in Madison, July 12-15 2012.</b><br/>
<br/>
 Invited speakers include:<br/>
- Jonathan Ewbank (Keynote)<br/>
- Marie-Anne F&eacute;lix<br/>
- Dennis Kim<br/>
- Sylvia Lee<br/>
- Patrick Hu<br/>
- Coleen Murphy<br/>
...
- Amy Pasquinelli<br/>
<br/>
In addition, talks and posters will be selected from abstracts (submission deadline: May 1st).<br/>
<br/>
Please visit the conference website: <a href=\"http://www.union.wisc.edu/ceaging/\">http://www.union.wisc.edu/ceaging/</a><br/>
<br/>
UW-Madison has been a wonderful setting for meetings in years past, and based on a polling of previous meeting participants we chose Madison to be the setting again for 2012. Most of the meeting will be held at the new Union South location (which just had its grand opening earlier last year (<a href=\"http://www.union.wisc.edu/visit-unionsouth.htm\">http://www.union.wisc.edu/visit-unionsouth.htm</a> - see pictures at <a href=\"http://photos.news.wisc.edu/photos/list?search=union+south\">http://photos.news.wisc.edu/photos/list?search=union+south</a>), with additional activities at the Memorial Union (by the famous lake and Terrace!).<br/>
<br/>
We hope to see you in Madison!<br/>
<br/>
Best,<br/>
<br/>
Malene Hansen, mhansen\@sanfordburnham.org<br/>
<br/>
Emily Troemel, etroemel\@ucsd.edu<br/><br/>";
  $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
