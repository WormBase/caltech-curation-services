...
#
# another announcement, 2012 04 30
#
# reminder for same announcement  2012 05 10
...
#   $email .= ', closertothewake@gmail.com';
  ...
  my $user = 'Jane Mendel <mendelj@caltech.edu>';
  my $subject = "The Worm Breeder's Gazette-call for new types of contributions";
  my $body = qq( Dear Worm Researchers,<br/>
<br/>
The Worm Breeder's Gazette has traditionally been a forum for the presentation of unpublished results.  However, the Gazette is also a newsletter and can provide additional types of information useful to the community.  We encourage you to submit the following three types of contributions:<br />
<br />
<b>1\) Have you published a paper in the last 6-12 months that includes a new or improved technique?</b>  Since we feel that one of the biggest strengths of the Gazette is to inform the community about technical advances in nematode research, we hope that you will contribute a summary of that technique.  <br />
<br />
<b>2\) Have you recently submitted an abstract to a worm meeting?</b>  It may be that you have gathered additional data between submission of your meeting abstract and your presentation.  We invite you to update your abstract and submit it to the Gazette.<br />
<br />
<b>3\) Have you set up a new lab in the last year?</b>  We invite you to submit an announcement of your new address along with a brief description of the research focus of your lab.<br />
<br />
Author instructions can be found at <a href="http://www.wormbook.org/wbg/instructions-for-authors/">http://www.wormbook.org/wbg/instructions-for-authors/</a>, where you will also find a link to our online submission form and a brief tutorial.  Once you have logged in, you can submit an article by clicking 'Add New' under the 'Articles' tab in the left sidebar.  You can save a draft and work on it at a later date.  Before you submit your article, please make sure to check it using the 'Preview' button.  This will ensure that you have included all the required information and that your article meets our length limitation.<br />
<br />
Our next deadline is Monday, June 4, but we may accommodate reasonable requests for late submissions.<br />
<br />
<br />
Thank you for your continued interest in the Worm Breeder's Gazette,<br />
<br/>
Jane<br/>
<br/>
<br/>
...
1200 E. California Blvd. 156-29<br/>
Pasadena, CA 91125<br/>
626/395-8903, 626/395-8484<br/>
mendelj\@caltech.edu<br/><br/>);
  $body .= "\n\nFollow this link to unsubscribe from newsletter and meeting announcements : http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/person.cgi?action=unsubscribe&two=two$twonum&passwd=$passwd";
