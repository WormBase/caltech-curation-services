...
# 2004 03 11
#
# Edited for Alessandro Puoti to notify change of deadline.  2004 04 15
...
sub mail_body {
  ...
  my $subject = 'Deadline European Worm Meeting 2004';
  my $body = "Dear colleagues,

The registration deadline for the European Worm Meeting 2004
(EWM2004) has been extended until Monday April 19th. In order to
avoid overloading the server, please try to submit your abstracts
over the next days.
