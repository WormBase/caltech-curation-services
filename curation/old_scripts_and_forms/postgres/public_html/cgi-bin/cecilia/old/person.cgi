...
my $start_date = '1970-01-01';		# date to compare against to check recency
...
sub compareWbg {			# main wbg comparison subroutine
  ...
  print "<FORM METHOD=\"POST\" ACTION=\"http://minerva.caltech.edu/~postgres/cgi-bin/cecilia/person.cgi\">\n";			# compare form, encompass wbg, aces, and wbgs
...
<CENTER><A HREF="http://minerva.caltech.edu/~postgres/cgi-bin/cecilia/person_doc.txt">Documentation</A></CENTER>
EndOfText
} # sub PrintHeader 
