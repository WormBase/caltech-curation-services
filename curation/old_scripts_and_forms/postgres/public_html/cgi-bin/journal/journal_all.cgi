...
#   http://tazendra.caltech.edu/~postgres/cgi-bin/journal/journal_all.cgi?afp_jfp=jfp
# for journal / old mode
#   http://tazendra.caltech.edu/~postgres/cgi-bin/journal/journal_all.cgi?afp_jfp=afp
# for author / new default mode.  2013 08 21
#
# sort papers in descending order for Karen.  2017 12 11
...
sub firstPage {
  &getJournalPapers();
  &getTextpressoDOIs();
  print "<form method=\"post\" action=\"http://tazendra.caltech.edu/~postgres/cgi-bin/journal/journal_all.cgi\">";
...
#   print "<option></option>";
  ...
  print "<tr><td align=\"left\">DOI</td><td align=\"left\">WBPaperID</td><td align=\"left\">pdf link</td><td align=\"left\">data link</td><td align=\"left\">go link</td></tr>\n";
  foreach my $joinkey (reverse sort keys %{ $pap{ident} } ) {
    my $pdf_link = 'no pdf'; my $pdf_url = 'asdf';
    if ($pap{pdf}{$joinkey}) { $pdf_link = $pap{pdf}{$joinkey}; }
    print "<tr>\n";
    print "<td align=\"left\">$pap{ident}{$joinkey}</td>\n";
    my $paper_link = "http://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/paper_display.cgi?data_number=$joinkey&action=Search+%21";
    ...
    print "<td align=\"left\"><a href=\"$journal_link\">link</a></td>\n";
