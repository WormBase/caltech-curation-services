...
# files
my $data_file = '/home/postgres/public_html/cgi-bin/data/curation_data_raymond.txt';
my $save_file = '/home/postgres/public_html/cgi-bin/data/curation_save_raymond.txt';
my $html_file = '/home/postgres/public_html/cgi-bin/curation_html_raymond.txt';
...
sub ResetForDisplay {
  ...
  $variables{curator} = "Raymond Lee";	# assign curator name
} # sub ResetForDisplay 
...
sub SaveState {
  ...
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_save_raymond.txt\">saved</A>.<P>\n";
...
sub OutputAndMail {
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_data_raymond.txt\">results</A> in the flatfile.<P>";
...
<HEAD>
<TITLE>Raymond's Curation Form</TITLE>
</HEAD>
...
sub ShowPgQuery {
  ...
  <FORM METHOD="POST" ACTION="http://minerva.caltech.edu/~postgres/cgi-bin/curation_raymond.cgi">
