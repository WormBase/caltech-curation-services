...
# files
my $data_file = '/home/postgres/public_html/cgi-bin/data/curation_data_andrei.txt';
my $save_file = '/home/postgres/public_html/cgi-bin/data/curation_save_andrei.txt';
my $html_file = '/home/postgres/public_html/cgi-bin/curation_html_andrei.txt';
  # set this to the path of the folder with the pdf files
my $attachment_path = '/home3/allpdfs/';

# emails
my $raymond = 'agp@its.caltech.edu';
my $erich = 'agp@its.caltech.edu';
my $wen = 'agp@its.caltech.edu';
my $rec_cgc = 'agp@its.caltech.edu';
my $rec_worm = 'agp@its.caltech.edu';
my $rec_syl = 'agp@its.caltech.edu';
...
sub ResetForDisplay {
  ...
  $variables{curator} = "Andrei Petcherski";	# assign curator name
} # sub ResetForDisplay 
...
sub SaveState {
  ...
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_save_andrei.txt\">saved</A>.<P>\n";
...
sub OutputAndMail {
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_data_andrei.txt\">results</A> in the flatfile.<P>";
...
<HEAD>
<TITLE>Andrei's Curation Form</TITLE>
</HEAD>
...
sub ShowPgQuery {
  ...
  <FORM METHOD="POST" ACTION="http://minerva.caltech.edu/~postgres/cgi-bin/curation_andrei.cgi">
