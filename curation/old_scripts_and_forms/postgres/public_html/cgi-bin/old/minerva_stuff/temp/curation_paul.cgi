...
# files
my $data_file = '/home/postgres/public_html/cgi-bin/data/curation_data_paul.txt';
my $save_file = '/home/postgres/public_html/cgi-bin/data/curation_save_paul.txt';
my $html_file = '/home/postgres/public_html/cgi-bin/curation_html_paul.txt';
...
sub ResetForDisplay {
  ...
  $variables{curator} = "Paul Sternberg";	# assign curator name
} # sub ResetForDisplay 
...
sub SaveState {
  ...
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_save_paul.txt\">saved</A>.<P>\n";
...
sub OutputAndMail {
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_data_paul.txt\">results</A> in the flatfile.<P>";
...
<HEAD>
<TITLE>Paul's Curation Form</TITLE>
</HEAD>
...
sub ShowPgQuery {
  ...
  <FORM METHOD="POST" ACTION="http://minerva.caltech.edu/~postgres/cgi-bin/curation_paul.cgi">
