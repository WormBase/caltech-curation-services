...
# files
my $data_file = '/home/postgres/public_html/cgi-bin/data/curation_data_erich.txt';
my $save_file = '/home/postgres/public_html/cgi-bin/data/curation_save_erich.txt';
my $html_file = '/home/postgres/public_html/cgi-bin/curation_html_erich.txt';
...
sub ResetForDisplay {
  ...
  $variables{curator} = "Erich Schwarz";	# assign curator name
} # sub ResetForDisplay 
...
sub SaveState {
  ...
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_save_erich.txt\">saved</A>.<P>\n";
...
sub OutputAndMail {
  print "See all <A HREF=\"http://minerva.caltech.edu/~postgres/cgi-bin/data/curation_data_erich.txt\">results</A> in the flatfile.<P>";
...
<HEAD>
<TITLE>Erich's Curation Form</TITLE>
</HEAD>
...
sub ShowPgQuery {
  ...
  <FORM METHOD="POST" ACTION="http://minerva.caltech.edu/~postgres/cgi-bin/curation_erich.cgi">
