...
sub matchWbg {				# make matches for main ace key, show in form
  ...
  print "<FORM METHOD=\"POST\" ACTION=\"http://minerva.caltech.edu/~postgres/cgi-bin/grouper.cgi\">\n";						# compare form, encompass wbg, aces, and wbgs
...
<CENTER><A HREF="http://minerva.caltech.edu/~postgres/cgi-bin/grouper_doc.txt">Documentation</A></CENTER>
EndOfText
} # sub PrintHeader 
