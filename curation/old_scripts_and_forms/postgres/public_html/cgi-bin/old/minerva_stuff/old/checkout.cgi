...
# This CGI http://minerva.caltech.edu/~postgres/cgi-bin/checkout.cgi
# 
...
sub ChooseCurator {
  print "<FORM METHOD=\"POST\" ACTION=\"http://minerva.caltech.edu/~postgres/cgi-bin/checkout.cgi\">";
  print "<TABLE>\n";
...
#                   print "<TD><A HREF=\"http://minerva.caltech.edu/~azurebrd/allpdfs/$1\">$1</A></TD>\n";	# print the link
                  print "<A HREF=\"http://minerva.caltech.edu/~azurebrd/allpdfs/$1\">$1</A><BR>\n";	# print the link
...
sub PrintFormOpen {		# open form link to appropriate curation_name.cgi 
  ...
  if ($curator eq 'Wen Chen') {
    ...
    print "<FORM METHOD=\"POST\" ACTION=\"http://minerva.caltech.edu/~postgres/cgi-bin/curation_ranjana.cgi\">";
...
sub showSearch {		# look for a specific number
  print <<"EndOfText";
  <FORM METHOD="POST" ACTION="http://minerva.caltech.edu/~postgres/cgi-bin/checkout.cgi">
  <TABLE><TR>
...
<HR>
<CENTER>Documentation <A HREF="http://minerva.caltech.edu/~postgres/cgi-bin/checkout_doc.txt" TARGET=NEW>here</A></CENTER><P>
EndOfText
} # sub PrintHeader 
