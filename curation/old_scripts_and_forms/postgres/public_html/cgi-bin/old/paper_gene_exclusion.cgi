...
#
# Changed Locus to Gene for Dan and Kimberly.  2005 02 07
...
sub ChooseCurator {
  print "<FORM METHOD=\"POST\" ACTION=\"http://tazendra.caltech.edu/~postgres/cgi-bin/paper_gene_exclusion.cgi\">";
  print "<TABLE>\n";
...
<FORM METHOD="POST" ACTION="http://tazendra.caltech.edu/~postgres/cgi-bin/paper_gene_exclusion.cgi">
