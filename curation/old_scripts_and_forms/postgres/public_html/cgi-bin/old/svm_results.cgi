...
#
# file last edited on 2012-01-26 17:14  I don't think anyone's using this
# because we have the curation_status form.  This gets all papers flagged 
# through SVM, but it's too slow, doing it all on the fly.  If this is wanted
# back, rewrite off of cur_svmdata .  Only advantage this has, is that it has
# all entries, not just the .concat.  No one's been using this for 51 weeks,
# other than a mention from the First Pass wiki, so I've edited that out 
# there.  2013 11 21
