...
#
# created &testDevserver(); to test that known value of dev site for e1 
# returns correctly, if not dev site is not working properly   
# for Karen / Jolene / Raymond's idea.  2007 11 13
...
sub printHtmlMenu {		# show main menu page
  ...
  if (scalar keys %exists) { print "<A HREF=\"http://tazendra.caltech.edu/~postgres/cgi-bin/allele_phenotype_curation.cgi?action=See%20Submissions\">There are " . scalar(keys %exists) . " entries from allele submission form to curate.</A><BR>\n"; }
