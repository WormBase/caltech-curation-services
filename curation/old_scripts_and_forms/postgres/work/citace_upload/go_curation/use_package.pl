...
# them.  2005 07 13
#
# Changed for go_annotations  2015 02 19
...
use lib qw( /home/postgres/work/citace_upload/go_curation );
use get_go_annotation_ace;

my $outfile = 'go_annotation.ace.' . $date;
my $outfile2 = 'go_annotation.ace';
...
my ($all_entry, $err_text) = &getGoAnnotation('all');

# my ($all_entry, $err_text) = &getGoAnnotation('WBPerson1843');
