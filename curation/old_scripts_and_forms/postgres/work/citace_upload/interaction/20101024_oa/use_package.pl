...
use lib qw( /home/postgres/work/citace_upload/interaction/20101024_oa/ );
use get_interaction_ace;

my $directory = '/home/postgres/work/citace_upload/interaction/20101024_oa/';
...
# my ($all_entry, $long_text, $err_text) = &getInteraction('WBInteraction0051774');
