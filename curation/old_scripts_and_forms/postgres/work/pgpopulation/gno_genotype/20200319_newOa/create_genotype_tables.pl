...
# create starting gno_ tables for Chris.  2020 03 19
# 
# https://wiki.wormbase.org/index.php/Genotype#Genotype_Postgres_Tables
...
my @tables = qw( identifier curator name synonym gene variation rearrangement transgene othercomp species remark paper nodump );
