...
# rna_ tables for RNAi OA  2012 03 24
...
my @tables = qw( name paper laboratory date curator pcrproduct dnatext sequence strain genotype treatment lifestage temperature deliverymethod species remark fromgenereg phenotype penfromto penetrance heatsens coldsens quantfromto quantdesc phenremark phenotypenot molecule person historyname movie database exprprofile nodump );
