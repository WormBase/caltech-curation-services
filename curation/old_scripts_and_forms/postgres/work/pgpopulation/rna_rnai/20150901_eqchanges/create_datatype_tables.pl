...
my @tables = qw( anatomy anatomyquality lifestagequality molaffected molaffectedquality goprocess goprocessquality  gofunction gofunctionquality gocomponent gocomponentquality );
