...
my @tables = qw( biorole bioroletext essentialfor status detctmethod extrctmethod chemicalsynthesis nonbiosource endogenousin otherdetctmethod otherextrctmethod );
