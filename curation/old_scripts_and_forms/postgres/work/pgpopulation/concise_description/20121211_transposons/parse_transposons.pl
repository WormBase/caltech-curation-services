...
# from from murray set of pic_ / exp_ to read in concise description transposons for Kimberly  2012 12 11
#
# live run on tazendra.  2012 12 17
...
my %gene;
# &populateObjects();		# all genes are okay, don't check again, takes too long

my ($con_pgid) = &getHighestPgid('con');

my $infile = 'transposons';
open (IN, "<$infile") or die "Cannot open $infile : $!";
my $headerline = <IN>;
while (my $line = <IN>) {
  chomp $line;
  my ($wbgene, $curator, $desctype, $desctext, @rest) = split/\t/, $line;
#   unless ($gene{$gene}) { print "ERR NOT a valid gene $gene\n"; next; }		# all genes are okay, don't check again, takes too long
  $con_pgid++;
  my $lastupdate = '2012-12-11 23:07:00';
  my $curhistory = $con_pgid;
  &addToPg($con_pgid, 'con_wbgene',      $wbgene);
  &addToPg($con_pgid, 'con_curator',     $curator);
  &addToPg($con_pgid, 'con_desctype',    $desctype);
  &addToPg($con_pgid, 'con_desctext',    $desctext);
  &addToPg($con_pgid, 'con_lastupdate',  $lastupdate);
  &addToPg($con_pgid, 'con_curhistory',  $curhistory);
} # while (my $line = <IN>)
...
DELETE FROM con_wbgene WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_curator WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_desctype WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_desctext WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_lastupdate WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_curhistory WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_wbgene_hst WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_curator_hst WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_desctype_hst WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_desctext_hst WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_lastupdate_hst WHERE con_timestamp > '2012-12-11 22:00';
DELETE FROM con_curhistory_hst WHERE con_timestamp > '2012-12-11 22:00';
...
if ($strain eq 'RW10757') { print "RW10757 AL $allele LINE $line\n"; }
    if ($alleleToTransgene{$allele}) { 
if ($strain eq 'RW10757') { print "RW10757 AL $allele alleleToTransgene{$allele} $alleleToTransgene{$allele} LINE $line\n"; }
$strainToTransgene{$strain}{$alleleToTransgene{$allele}}++; }
      else { 
if ($strain eq 'RW10757') { print "ERR RW10757 AL $allele no alleleToTransgene{$allele} LINE $line\n"; }
print qq(ERR $allele does not map to transgeneID $line\n); } }
} # while (my $line = <IN>)
...
__END__
  ...
  DELETE FROM exp_name        WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_paper       WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_exprtype    WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_curator     WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_strain      WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_pattern     WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_qualifier   WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_gene        WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_anatomy     WHERE exp_timestamp > '2012-10-25 13:51';
  DELETE FROM exp_transgene   WHERE exp_timestamp > '2012-10-25 13:51';

  DELETE FROM mov_name        WHERE mov_timestamp > '2012-10-25 13:51';
  DELETE FROM mov_source      WHERE mov_timestamp > '2012-10-25 13:51';
  DELETE FROM mov_exprpattern WHERE mov_timestamp > '2012-10-25 13:51';
  DELETE FROM mov_curator     WHERE mov_timestamp > '2012-10-25 13:51';
  DELETE FROM mov_remark      WHERE mov_timestamp > '2012-10-25 13:51';

  DELETE FROM pic_name        WHERE pic_timestamp > '2012-10-25 13:51';
  DELETE FROM pic_contact     WHERE pic_timestamp > '2012-10-25 13:51';
  DELETE FROM pic_description WHERE pic_timestamp > '2012-10-25 13:51';
  DELETE FROM pic_source      WHERE pic_timestamp > '2012-10-25 13:51';
  DELETE FROM pic_exprpattern WHERE pic_timestamp > '2012-10-25 13:51';
  DELETE FROM pic_curator     WHERE pic_timestamp > '2012-10-25 13:51';
  DELETE FROM pic_remark      WHERE pic_timestamp > '2012-10-25 13:51';
