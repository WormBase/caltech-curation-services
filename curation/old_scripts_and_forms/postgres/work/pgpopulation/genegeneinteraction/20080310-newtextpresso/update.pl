...
# Updated for new textpresso  2008 03 10

# cronjob set :
# 0 5 1 * * # /home/postgres/work/pgpopulation/andrei_genegeneinteraction/20080310-newtextpresso/update.pl
...
my $directory = '/home/postgres/work/pgpopulation/andrei_genegeneinteraction/20080310-newtextpresso';
chdir($directory) or die "Cannot go to $directory ($!)";

my $source = get("http://main.textpresso.org/azurebrd/ggi_updates/ggi_lines");
my $ggi_lines = 'ggi_lines';
open (GGI, ">$ggi_lines") or die "Cannot create $ggi_lines : $!";
print GGI $source;
close (GGI) or die "Cannot close $ggi_lines : $!";
