...
#
# I messed up and dropped all those tables while dropping other tables that were unnecessary.  
# had to recreate with this script, and repopulate what was removed.  2013 11 21
...
my @tables = qw( paper wbgene project curator goontology goid goinference accession with_wbgene with_wbvariation with qualifier xrefto dbtype protein comment lastupdate );
