...
#
# changed to move gop_paper_evidence to gop_paper and gop_curator_evidence to gop_curator.  2011 05 22
...
my @tables = qw( curator paper );

# COPY gop_curator_evidence TO '/home/postgres/work/pgpopulation/go/20110522_curator_paper/curator_evidence.pg';
# COPY gop_curator_evidence_hst TO '/home/postgres/work/pgpopulation/go/20110522_curator_paper/curator_evidence_hst.pg';
# COPY gop_paper_evidence TO '/home/postgres/work/pgpopulation/go/20110522_curator_paper/paper_evidence.pg';
# COPY gop_paper_evidence_hst TO '/home/postgres/work/pgpopulation/go/20110522_curator_paper/paper_evidence_hst.pg';
# 
# COPY gop_curator FROM '/home/postgres/work/pgpopulation/go/20110522_curator_paper/curator_evidence.pg';
# COPY gop_curator_hst FROM '/home/postgres/work/pgpopulation/go/20110522_curator_paper/curator_evidence_hst.pg';
# COPY gop_paper FROM '/home/postgres/work/pgpopulation/go/20110522_curator_paper/paper_evidence.pg';
# COPY gop_paper_hst FROM '/home/postgres/work/pgpopulation/go/20110522_curator_paper/paper_evidence_hst.pg';
# 
# DELETE FROM oac_column_width    WHERE oac_datatype = 'gop' AND (oac_table = 'paper_evidence' OR oac_table = 'curator_evidence');
# DELETE FROM oac_column_order    WHERE oac_datatype = 'gop' AND (oac_table = 'paper_evidence' OR oac_table = 'curator_evidence');
# DELETE FROM oac_column_showhide WHERE oac_datatype = 'gop' AND (oac_table = 'paper_evidence' OR oac_table = 'curator_evidence');
# 
# DROP TABLE gop_paper_evidence ;
# DROP TABLE gop_paper_evidence_hst ;
# DROP TABLE gop_curator_evidence ;
# DROP TABLE gop_curator_evidence_hst ;
