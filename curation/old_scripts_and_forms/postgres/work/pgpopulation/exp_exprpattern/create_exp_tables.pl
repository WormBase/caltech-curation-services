...
#
# got rid of cell permanently, split anat_term into certain/partial/uncertain, temporarily got rid of author+date+curatedby since they are frozen and unnecessary to query / &c.  2011 05 06
#
# got rid of picture, created in acedb via xref from picture curation  2011 05 13
...
# my @tables = qw( name paper gene certain partial uncertain goid subcellloc lifestage exprtype antibodytext reportergene insitu rtpcr northern western picture pictureflag antibody antibodyflag pattern remark transgene transgeneflag curator nodump protein clone strain sequence movieurl laboratory author date curatedby );	# temporarily don't have author date curatedby
my @tables = qw( name paper gene anatomy qualifier qualifiertext goid subcellloc lifestage exprtype antibodytext reportergene insitu rtpcr northern western pictureflag antibody antibodyflag pattern remark transgene transgeneflag curator nodump protein clone strain sequence movieurl laboratory );
...
Edit users to grant permission to, edit the datatype, edit the array of tables that list the table values, then run with
...
Edit postgres database users to grant permission to, edit the datatype, edit the @tables array of tables, then run with
