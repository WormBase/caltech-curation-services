...
#
# live on tazendra, populated with toggle ON for all entries that have an exp_gene on tazendra only, not mangolassi.  2014 03 20
...
# my @tables = qw( dnatext species );
my @tables = qw( endogenous );
