...
my @tables = qw( name paper gene anat_term goid subcellloc lifestage exprtype antibodytext reportergene insitu rtpcr northern western picture pictureflag antibody antibodyflag pattern remark transgene transgeneflag curator nodump protein clone strain cell sequence movieurl laboratory person date curatedby );
