...
my @tables = qw( inferredgene associationtype goinference qualifier geneticsex inducingchemical inducingagent commentexpcond modtransgene modvariation modstrain modgene modmolecule modother phenotypeameliorated phenotypeexacerbated commentdisphen );
