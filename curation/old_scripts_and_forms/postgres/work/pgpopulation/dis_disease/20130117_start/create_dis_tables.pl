...
my @tables = qw( wbgene curator curhistory humandoid paperexpmod dbexpmod species lastupdateexpmod diseaserelevance paperdisrel dbdisrel lastupdatedisrel comment );
