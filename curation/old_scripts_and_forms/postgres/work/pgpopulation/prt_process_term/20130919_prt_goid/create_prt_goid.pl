...
# create  process term tables prt_  2012 07 01
#
# create  process term goid tables prt_goid  2013 09 19
...
# my @tables = qw( curator processid processname summary othername relprocess remark paper );
my @tables = qw( goid );
