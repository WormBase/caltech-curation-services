...
##############################################################################
#
# Development script then copied over to 
# /home/postgres/work/pgpopulation/wpa_new_wbpaper_tables/perl_wpa_match/pmid/pubmed_fetch_from_module.pl
...
# DELETE FROM wpa WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_title WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_identifier WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_journal WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_volume WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_pages WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_year WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_type WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_abstract WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_gene WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_author WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
# DELETE FROM wpa_author_index WHERE wpa_timestamp > '2005-08-16 16:10:00' AND wpa_curator = 'two324';
