...
# copied for parasite no cronjob set yet.
# 
#
...
#
# copied for parasite for Michael Paulini.  2016 10 14
#
#
# cronjob
# 0 1 * * * /home/postgres/work/pgpopulation/wpa_papers/pmid_parasite_downloads/get_new_elegans_xml.pl
...
my $directory = '/home/postgres/work/pgpopulation/wpa_papers/pmid_parasite_downloads';
...
# my $highest = 26870108;							# testing small set 2016 02 18
# my $highest = 26860000;							# testing small set 2016 03 01
# my $highest = 19000000;							# eventual set for jane 2016 03 01
my $highest = 1;							# get all for jane 2016 03 15
...
# my $url = qq(http://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=helminth[Title%2FAbstract]+OR+nematode[Title%2FAbstract]+OR+worm[Title%2FAbstract]+OR+nematodes[Title%2FAbstract]+OR+helminths[Title%2FAbstract]+OR+worms[Title%2FAbstract]%29+AND+%28parasite[Title%2FAbstract]+OR+parasitic[Title%2FAbstract]%29+OR+filarial[Title%2FAbstract]&retmax=1000000);
my $url = qq(https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&amp;term=malayi[Title%2FAbstract]+OR+ratti[Title%2FAbstract]+OR+volvulus[Title%2FAbstract]%29+AND+%28parasite[Title%2FAbstract]+OR+parasitic[Title%2FAbstract]+OR+filarial[Title%2FAbstract]+OR+nematode[Title%2FAbstract]+OR+nematodes[Title%2FAbstract]+OR+worm[Title%2FAbstract]+OR+worms[Title%2FAbstract]%29&amp;retmax=1000000);
...
#   my $outfile = $directory . "/temp/$pmid";
...
# &populateNotfinal();			# /home/postgres/work/pgpopulation/wpa_papers/pmid_downloads/get_new_elegans_xml.pl does this part for all pmids


# sub populateNotfinal {
#   my ($date) = &getSimpleDate();
#   return unless ($date =~ m/13$/);	# only run this on the 19th of the month
#   my %pmids;
