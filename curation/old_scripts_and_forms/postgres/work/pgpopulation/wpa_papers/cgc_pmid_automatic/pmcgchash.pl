...
# after each update.  Same for /home/acedb/andrei/ version because used by Andrei
# pmid updates.  2003 06 05
#
...
my $insertfile = '/home/postgres/work/pgpopulation/cgc_pmid_automatic/insertfile.pl';
...
# new web server user is apache
  print INS "\$result = \$conn\->exec( \"GRANT ALL ON ref_xref TO apache \");\n";
