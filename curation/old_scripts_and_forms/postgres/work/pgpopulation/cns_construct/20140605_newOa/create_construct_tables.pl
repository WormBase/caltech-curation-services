...
# create starting cns_ tables for Karen.  2014 06 05
...
my @tables = qw( curator paper person name publicname othername newtransgene summary merge drivenbygene gene reporter otherreporter purificationtag recombinationsite constructtype selectionmarker threeutr constructionsummary proposedfeature fwdprimer revprimer dna feature genewithfeature clone laboratory remark );
