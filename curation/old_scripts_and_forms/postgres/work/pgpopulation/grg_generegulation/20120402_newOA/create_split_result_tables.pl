...
my @tables = qw( pos_anatomy pos_lifestage pos_scl pos_scltext neg_anatomy neg_lifestage neg_scl neg_scltext not_anatomy not_lifestage not_scl not_scltext );
