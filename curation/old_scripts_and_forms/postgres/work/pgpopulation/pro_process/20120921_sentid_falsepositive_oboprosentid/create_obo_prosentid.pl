...
# Create obo_{name|syn|data}_prosentid tables for process sentences in postgres.  2012 09 21
...
my %obos;
$obos{prosentid} = 'http://131.215.52.209/karen/rank_paper_fullpaper_filtered';
