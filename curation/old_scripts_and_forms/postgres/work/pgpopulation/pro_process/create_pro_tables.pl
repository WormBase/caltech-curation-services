...
# create process curation tables pro_ 2012 07 01
...
# my @tables = qw( name processterm summary othername relprocess taxon remark paper wbgene exprcluster interaction anat_term lifestage molecule phenotype goid humdisease picture movie pathwaydb pathwayacc curator );		# original process OA tables, OA never used between 2012-01-19 and 2012-07-01
my @tables = qw( curator paper process goid wbgene phenotype molecule anatomy lifestage taxon exprcluster humdisease picture movie pathwaydb );
