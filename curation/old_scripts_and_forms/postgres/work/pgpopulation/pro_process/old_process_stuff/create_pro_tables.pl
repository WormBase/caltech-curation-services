...
my @tables = qw( name processterm summary othername relprocess taxon remark paper wbgene exprcluster interaction anat_term lifestage molecule phenotype goid humdisease picture movie pathwaydb pathwayacc curator );
