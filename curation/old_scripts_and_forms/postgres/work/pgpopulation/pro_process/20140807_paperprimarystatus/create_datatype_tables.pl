...
# create pro_paperprimarystatus   Chris needs to be able to manually run  populate_pro_paperprimarystatus.pl  so acedb needs full permission.  2014 08 07
...
my @tables = qw( paperprimarystatus );
