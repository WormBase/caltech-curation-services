...
my @tables = qw( molaffected goprocess goprocessquality  gofunction gofunctionquality gocomponent gocomponentquality anatomy anatomyquality lifestagequality molaffectedquality pathogen );
