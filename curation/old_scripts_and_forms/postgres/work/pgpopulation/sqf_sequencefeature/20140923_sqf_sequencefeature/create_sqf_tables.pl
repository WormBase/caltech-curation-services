...
my @tables = qw( curator name publicname othername description species deprecated paper person analysis method soterm dnatext flanka flankb target sequence mergedinto wbgene exprpattern intid cds operon construct boundbyproduct trascriptionfactor confidential remark score );
