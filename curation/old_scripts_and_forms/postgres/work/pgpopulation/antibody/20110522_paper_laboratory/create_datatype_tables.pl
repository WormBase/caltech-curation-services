...
#
# changed to move abp_reference to abp_paper and abp_location to abp_laboratory  2011 05 22
...
my @tables = qw( laboratory paper );

# COPY abp_reference TO '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/reference.pg';
# COPY abp_reference_hst TO '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/reference_hst.pg';
# COPY abp_location TO '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/location.pg';
# COPY abp_location_hst TO '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/location_hst.pg';

# COPY abp_laboratory FROM '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/location.pg';
# COPY abp_laboratory_hst FROM '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/location_hst.pg';
# COPY abp_paper FROM '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/reference.pg';
# COPY abp_paper_hst FROM '/home/postgres/work/pgpopulation/antibody/20110522_paper_laboratory/reference_hst.pg';

# DELETE FROM oac_column_width    WHERE oac_datatype = 'abp' AND (oac_table = 'location' OR oac_table = 'reference');
# DELETE FROM oac_column_order    WHERE oac_datatype = 'abp' AND (oac_table = 'location' OR oac_table = 'reference');
# DELETE FROM oac_column_showhide WHERE oac_datatype = 'abp' AND (oac_table = 'location' OR oac_table = 'reference');

# DROP TABLE abp_location ;
# DROP TABLE abp_location_hst ;
# DROP TABLE abp_reference ;
# DROP TABLE abp_reference_hst ;
