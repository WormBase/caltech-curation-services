...
#
# Tried running fromdos on copy of AbsFilesOrig into Fromdos folder, but that didn't seem to help.
# utf-8 seems to work better for 2021, leaving 113 bad characters, vs 500 with iso-8859,
# vs 499 with unaccentHtml, vs 600 by default.
# converted for IWM2021.  2022 03 31
#
# Kimberly likes the output from UnaccentHtmlUTF8 generated by running unaccentHtml.pl
# using unac_string("utf-8", $line) with output to UnaccentHtmlUTF8/
# There's some issues in populating with lines like
# DBD::Pg::db do failed: ERROR:  invalid byte sequence for encoding "UTF8": 0xe28020
# HINT:  This error can also happen if the byte sequence does not match the encoding expected by the server, which is controlled by "client_encoding". at /home/postgres/work/pgpopulation/pap_papers/new_papers/pap_match.pm line 520, <IN> line 1204.
# Some entries like  wm2021ab1110  don't get into postgres, like the 2nd of 3 affiliations,
# while others do go in with garbled characters, like  wm2021ab1133  abstract.  
# Kimberly will see if she can fix it manually through the editor afterward.
# 2022 04 07
...
$/ = undef;
my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/UnaccentHtmlUTF8/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/UnaccentHtml/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/UnaccentUTF8/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/UnaccentFromdos/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/Fromdos/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/UnaccentUTF16/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/UnaccentISO-8859/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/AbsFiles/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/AbsFiles/1035B.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2021/AbsFiles/1019A.txt>;
my $count = 0;
...
sub processFile {
  ...
  if ($file =~ m/AbstractNo : (\d+)/) {
       ...
       my $identifier = 'wm2021ab' . $abs_num;
...
#   my $json = encode_json \%hash;
  my $json = JSON->new->pretty->canonical->encode(\%hash);
  print qq($json\n);
...
DELETE FROM pap_identifier WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_status WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_primary_data WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_title WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_journal WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_year WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_month WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_type WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_author WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_author_index WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_abstract WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_affiliation WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_gene WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM pap_curation_flags WHERE pap_timestamp > '2022-04-08 08:00';

DELETE FROM h_pap_identifier WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_status WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_primary_data WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_title WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_journal WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_year WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_month WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_type WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_author WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_author_index WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_abstract WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_affiliation WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_gene WHERE pap_timestamp > '2022-04-08 08:00';
DELETE FROM h_pap_curation_flags WHERE pap_timestamp > '2022-04-08 08:00';
