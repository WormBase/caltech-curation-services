...
#
# converted for IWM2017.  2017 07 20
#
# converted for IWM2019.  2019 09 09
...
$/ = undef;
my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2019/AbsFiles/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2019/AbsFiles/1035B.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2019/AbsFiles/1019A.txt>;
my $count = 0;
...
sub processFile {
  ...
  $file =~ s/<br \/>?\n/ /g;		# this is messing up some abstracts 2019 14 21

  my %hash;
  $hash{'year'} = 2019;
  $hash{'journal'} = "International Worm Meeting";
  $hash{'status'} = 'valid';
  ...
  if ($file =~ m/AbstractNo : (\d+)/) {
       ...
       my $identifier = 'wm2019ab' . $abs_num;
...
# foreach my $auth (@auths) { print "AU $auth TH\n"; }
  ...
  if (scalar(@affiliation) > 0) { $hash{'affiliation'} = \@affiliation; }
...
sub fixHtml {
  my $file = shift;
# find hex ncr here to \x codes  https://r12a.github.io/apps/conversion/  http://www.garykessler.net/library/ascii.html
  $file =~ s/\xb0/ deg /g;		# °
  $file =~ s/\xb1/ plus or minus /g;	# ±
  $file =~ s/\xdf/ beta /g;		# ß
  $file =~ s/\xae/ registered /g;	# ®
  $file =~ s/\xa7/ ss /g;		# §
  $file =~ s/\xd7/ x /g;		# ×
  $file =~ s/<b>//g;
  $file =~ s/<\/b>//g;
...
sub filterJunk {
  ...
  $para =~ s/ville, R.mi/ville, Remi/g;
    ...
    # iwm 2017
  $para =~ s/, P<4.2E.4\), PapD/, P<4.2E-4), PapD/g;
  $para =~ s/y the ge.neticall/y the geneticall/g;
  $para =~ s/coloniza.tion met/colonization met/g;
  $para =~ s/determin.istic, a/deterministic, a/g;
  $para =~ s/7 promis.ing cand/6 promising cand/g;
  $para =~ s/nal stud.ies, we /nal studies, we /g;
  $para =~ s/states\..$/states./g;
...
DELETE FROM pap_identifier WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_status WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_primary_data WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_title WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_journal WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_year WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_month WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_type WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_author WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_author_index WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_abstract WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_affiliation WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_gene WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM pap_curation_flags WHERE pap_timestamp > '2019-09-19 14:00';

DELETE FROM h_pap_identifier WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_status WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_primary_data WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_title WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_journal WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_year WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_month WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_type WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_author WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_author_index WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_abstract WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_affiliation WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_gene WHERE pap_timestamp > '2019-09-19 14:00';
DELETE FROM h_pap_curation_flags WHERE pap_timestamp > '2019-09-19 14:00';
