...
$/ = undef;
my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2017/AbsFiles/*.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2017/AbsFiles/1035B.txt>;
# my (@files) = </home/postgres/work/pgpopulation/pap_papers/abstracts/iwm2017/AbsFiles/1019A.txt>;
my $count = 0;
...
sub processFile {
  ...
  $file =~ s/<br \/>?\n/ /g;		# this is messing up some abstracts 2017 07 21
  ...
  if ($file =~ m/AbstractNo : (\d+)/) {
       ...
       my $identifier = 'wm2017ab' . $abs_num;
...
DELETE FROM pap_identifier WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_status WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_primary_data WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_title WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_journal WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_year WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_month WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_type WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_author WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_author_index WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_abstract WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_affiliation WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_gene WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM pap_curation_flags WHERE pap_timestamp > '2017-07-20 12:00';

DELETE FROM h_pap_identifier WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_status WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_primary_data WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_title WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_journal WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_year WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_month WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_type WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_author WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_author_index WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_abstract WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_affiliation WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_gene WHERE pap_timestamp > '2017-07-20 12:00';
DELETE FROM h_pap_curation_flags WHERE pap_timestamp > '2017-07-20 12:00';
