...
my $infile = 'DevGene_EMBL_Abstracts4_2010.txt';
# my $infile = 'DevGene_EMBL_Abstracts3_2010.txt';
...
#   next unless ($entry =~ m/Title/);
  $count++; 
#   last if ($count > 3);
  my ($last, $first, $authors, $title, $abstract, $e) = split/\t/, $entry;
  my @authors;
...
# unless ($authors) { print "NO AUTHORS $entry END\n"; next; }
  if ($authors) {
    my (@auts) = split/\;/, $authors; 
    foreach my $author (@auts) {
      if ($author =~ m/\"/) { $author =~ s/\"//g; }
      if ($author =~ m/\(.*?\)/) { $author =~ s/\(.*?\)//g; }
      if ($author =~ m/\./) { $author =~ s/\.//g; }
      if ($author =~ m/^\s+/) { $author =~ s/^\s+//g; }
      if ($author =~ m/\s+$/) { $author =~ s/\s+$//g; }
      push @authors, $author; } }
  my $fa = "$last, $first";
  unshift @authors, $fa;
  ...
  if ($abstract =~ m/\s*\"\s*$/) { $abstract =~ s/\s*\"\s*$//; }
  my $identifier = 'devgenewm2010_ab';
  my $journal = 'C. elegans: Development and Gene Expression, EMBL, Heidelberg, Germany';
  my $year = '2010';
  my $month = '6';
...
DELETE FROM pap_identifier WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_status WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_primary_data WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_title WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_journal WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_year WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_month WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_type WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_author WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_author_index WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_abstract WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM pap_gene WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_identifier WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_status WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_primary_data WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_title WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_journal WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_year WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_month WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_type WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_author WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_author_index WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_abstract WHERE pap_timestamp > '2010-08-13 12:13';
DELETE FROM h_pap_gene WHERE pap_timestamp > '2010-08-13 12:13';
