...
# 2023 08 04
#
# modified from populate_pap_identifier_agrkb.pl to get WB->AGR in simple way to flatfile.
# 2023 08 20
...
my $xref_file_path = '/home/postgres/work/agr_upload/pap_papers/20230609_topic_entity_classifier/files/ref_xref.json';
...
#   &generateXrefJsonFile();
  ...
  my $outfile = '/home/postgres/work/agr_upload/pap_papers/20230609_topic_entity_classifier/files/wb_abc';
...
#     $count++; last if ($count > 10);
  ...
  foreach my $wbp (sort keys %abcWbpToAgr) {
    print OUT qq($wbp\t$abcWbpToAgr{$wbp}\n);
  }
