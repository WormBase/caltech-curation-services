...
# 
# Dockerized and cronjob output to https://caltech-curation.textpressolab.com:4432/files/pub/wbperson_lineage_scaling/
...
my $outDir = $ENV{CALTECH_CURATION_FILES_INTERNAL_PATH} . "/pub/wbperson_lineage_scaling/";
...
my $lines = join",\n", @lines;
my $outfile = $outDir . 'wbpersonLineageScaling.json';
...
$lines = join",\n", @lines_integers;
$outfile = $outDir . 'wbpersonLineageScalingIntegers.json';
