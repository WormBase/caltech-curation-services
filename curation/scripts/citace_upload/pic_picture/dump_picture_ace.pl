...
sub readMappings {
  my $mappingfile = '/usr/caltech_curation_files/daniela/oa_picture_ace_dumper/Mappings.txt';
...
sub readJournalHasPermission {
  my $journalpermission_file = '/usr/caltech_curation_files/daniela/oa_picture_ace_dumper/journal_with_permission';
...
sub readUrlacc {
  my $infile = '/usr/caltech_curation_files/daniela/oa_picture_ace_dumper/picture_source';
