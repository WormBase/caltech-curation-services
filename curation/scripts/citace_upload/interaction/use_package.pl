...
use lib qw( /usr/lib/scripts/citace_upload/interaction/ );
...
# my ($all_entry, $err_text) = &getInteraction('WBPaper00036358_lin-11');
# my ($all_entry, $err_text) = &getInteraction('cgc2583_par');
