...
# if it's not already a wbgene, and only has a single WBGene.  
# on dockerized a really old version of this module seemed to be used instead of the latest one.
# 2023 03 27
