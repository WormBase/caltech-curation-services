...
my $annotFile = 'gp_annotation.ace';
...
my $sourcefile = 'http://current.geneontology.org/products/upstream_and_raw_data/noctua_wb.gpad.gz';
# my $sourcefile = 'http://current.geneontology.org/products/annotations/noctua_wb.gpad.gz';
# my $sourcefile = 'http://skyhook.berkeleybop.org/issue-238-wormbase-test-pipeline/products/annotations/noctua_wb.gpad.gz';
`wget $sourcefile`;
