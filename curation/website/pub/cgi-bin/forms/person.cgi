...
# my @normal_tables = qw( email firstname middlename lastname standardname institution street city state post country old_institution mainphone labphone officephone otherphone fax old_email lab oldlab orcid left_field webpage );	# 2022 10 28 getting rid of mainphone labphone officephone otherphone fax 
my @normal_tables = qw( email firstname middlename lastname standardname institution street city state post country old_institution old_email lab oldlab orcid left_field webpage );
...
sub displayFormInstructions {
  ...
  print "Please email <a href=mailto:cecnak\@wormbase.org>Cecilia</a> if you have any questions, or to send her your data directly.<P>\n";
