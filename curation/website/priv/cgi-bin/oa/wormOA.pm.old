...
#   $fields{dis}{modelremark}{cols_size}               = '100';
  $fields{dis}{inferredgene}{type}                   = 'multiontology';
  $fields{dis}{inferredgene}{label}                  = 'Inferred Gene';
  $fields{dis}{inferredgene}{tab}                    = 'tab1';
  $fields{dis}{inferredgene}{ontology_type}          = 'WBGene';
  $fields{dis}{inferredhumangene}{type}              = 'ontology';
  $fields{dis}{inferredhumangene}{label}             = 'Inferred Human Gene';
  $fields{dis}{inferredhumangene}{tab}               = 'tab1';
  $fields{dis}{inferredhumangene}{ontology_type}     = 'obo';
  $fields{dis}{inferredhumangene}{ontology_table}    = 'hgnc';
