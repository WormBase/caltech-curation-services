...
our @ISA        = qw(Exporter);
our @EXPORT     = qw( initModFields loginMod setAnySimpleAutocompleteValues getAnySpecificAutocomplete getAnySpecificValidValue getAnySpecificTermInfo getAnySpecificIdToValue populateWormDatatypeList );
our $VERSION    = 1.00;
...
sub initWormFields {
  ...
  elsif ($datatype eq 'gno') { ($fieldsRef, $datatypesRef) = &initWormGnoFields($datatype, $curator_two); }
...
sub initWormAbpFields {
  ...
  $fields{abp}{publicname}{type}                     = 'text';
  $fields{abp}{publicname}{label}                    = 'Public Name';
  $fields{abp}{publicname}{tab}                      = 'tab1';
  ...
  $fields{abp}{laboratory}{ontology_type}            = 'Laboratory';
...
sub initWormAppFields {
  ...
  $fields{app}{strain}{type}                         = 'ontology';
  $fields{app}{strain}{label}                        = 'Strain';
  $fields{app}{strain}{tab}                          = 'tab1';
  $fields{app}{strain}{ontology_type}                = 'obo';
  $fields{app}{strain}{ontology_table}               = 'strain';
  ...
  $fields{app}{hgnc}{type}                           = 'multiontology';
  $fields{app}{hgnc}{label}                          = 'Human Gene';
  $fields{app}{hgnc}{tab}                            = 'tab1';
  $fields{app}{hgnc}{ontology_type}                  = 'obo';
  $fields{app}{hgnc}{ontology_table}                 = 'hgnc';
...
#   $fields{app}{quality}{ontology_table}              = 'quality';
  ...
  $fields{app}{pathogen}{ontology_type}              = 'Papspecies';
...
#   $fields{app}{pathogen}{ontology_table}             = 'ncbitaxonid';
  ...
  $fields{app}{picture}{type}                        = 'ontology';
  $fields{app}{picture}{label}                       = 'Picture';
  $fields{app}{picture}{tab}                         = 'tab5';
  $fields{app}{picture}{ontology_type}               = 'WBPicture';
  ...
  $fields{app}{controlstrain}{type}                  = 'ontology';
  $fields{app}{controlstrain}{label}                 = 'Control_strain';
  $fields{app}{controlstrain}{tab}                   = 'tab5';
  $fields{app}{controlstrain}{ontology_type}         = 'obo';
  $fields{app}{controlstrain}{ontology_table}        = 'strain';
...
#   $fields{app}{nbp}{noteditable}                     = 'noteditable';	# temporarily allow editing 2021 04 16
...
#   $fields{app}{species}{dropdown_type}               = 'species';
  ...
  $fields{app}{laboratory}{ontology_type}            = 'Laboratory';
  ...
  $fields{app}{unregvariation}{type}                 = 'bigtext';
...
#   $fields{app}{curation_status}{dropdown_type}       = 'curationstatus';
  ...
  $fields{app}{micropublication}{type}               = 'toggle';
  $fields{app}{micropublication}{label}              = 'Micropublication';
  $fields{app}{micropublication}{tab}                = 'tab6';
...
#   $fields{cns}{merge}{tab}                           = 'tab1';
  ...
  $fields{cns}{hgnc}{type}                           = 'multiontology';
  $fields{cns}{hgnc}{label}                          = 'HGNC';
  $fields{cns}{hgnc}{tab}                            = 'tab2';
  $fields{cns}{hgnc}{ontology_type}                  = 'obo';
  $fields{cns}{hgnc}{ontology_table}                 = 'hgnc';
...
#   $fields{cns}{feature}{ontology_table}              = 'feature';
  ...
  $fields{cns}{laboratory}{ontology_type}            = 'Laboratory';
  ...
  $fields{cns}{strain}{type}                         = 'multiontology';
  $fields{cns}{strain}{label}                        = 'Strain';
  $fields{cns}{strain}{tab}                          = 'tab3';
  $fields{cns}{strain}{ontology_type}                = 'obo';
  $fields{cns}{strain}{ontology_table}               = 'strain';
  ...
  $fields{cns}{transgenome}{type}                    = 'text';
  $fields{cns}{transgenome}{label}                   = 'Transgenome Acc#';
  $fields{cns}{transgenome}{tab}                     = 'tab4';
  $fields{cns}{addgene}{type}                        = 'text';
  $fields{cns}{addgene}{label}                       = 'Addgene ID';
  $fields{cns}{addgene}{tab}                         = 'tab4';
...
#   $fields{dis}{species}{type}                        = 'dropdown';
  ...
  $fields{dis}{species}{label}                       = 'Disease of Species';
  $fields{dis}{species}{tab}                         = 'tab1';
#   $fields{dis}{species}{dropdown_type}               = 'species';
  ...
  $fields{dis}{wbgene}{label}                        = 'Disease Relevant Gene';
  $fields{dis}{wbgene}{tab}                          = 'tab1';
  $fields{dis}{wbgene}{ontology_type}                = 'WBGene';
#   $fields{dis}{wbgenetext}{type}                     = 'text';
#   $fields{dis}{wbgenetext}{label}                    = 'Disease Relevant Gene Text';
#   $fields{dis}{wbgenetext}{tab}                      = 'tab1';
  $fields{dis}{variation}{type}                      = 'ontology';
  $fields{dis}{variation}{label}                     = 'Variation';
  $fields{dis}{variation}{tab}                       = 'tab1';
  $fields{dis}{variation}{ontology_type}             = 'obo';
  $fields{dis}{variation}{ontology_table}            = 'variation';
#   $fields{dis}{variationtext}{type}                  = 'text';
#   $fields{dis}{variationtext}{label}                 = 'Variation Text';
#   $fields{dis}{variationtext}{tab}                   = 'tab1';
  $fields{dis}{strain}{type}                         = 'ontology';
  $fields{dis}{strain}{label}                        = 'Strain';
  $fields{dis}{strain}{tab}                          = 'tab1';
  $fields{dis}{strain}{ontology_type}                = 'obo';
  $fields{dis}{strain}{ontology_table}               = 'strain';
#   $fields{dis}{straintext}{type}                     = 'textarea';
#   $fields{dis}{straintext}{label}                    = 'Strain Text';
#   $fields{dis}{straintext}{tab}                      = 'tab1';
#   $fields{dis}{straintext}{cols_size}                = '60';
#   $fields{dis}{straintext}{rows_size}                = '7';
#   $fields{dis}{suggested_strain}{type}               = 'text';
#   $fields{dis}{suggested_strain}{label}              = 'Requested Strain';
#   $fields{dis}{suggested_strain}{tab}                = 'tab1';
  $fields{dis}{transgene}{type}                      = 'ontology';
  $fields{dis}{transgene}{label}                     = 'Transgene';
  $fields{dis}{transgene}{tab}                       = 'tab1';
  $fields{dis}{transgene}{ontology_type}             = 'Transgene';
#   $fields{dis}{transgenetext}{type}                  = 'text';
#   $fields{dis}{transgenetext}{label}                 = 'Transgene Text';
#   $fields{dis}{transgenetext}{tab}                   = 'tab1';
  $fields{dis}{genotype}{type}                       = 'ontology';
  $fields{dis}{genotype}{label}                      = 'Genotype';
  $fields{dis}{genotype}{tab}                        = 'tab1';
  $fields{dis}{genotype}{ontology_type}              = 'WBGenotype';
#   $fields{dis}{interactvariation}{type}              = 'multiontology';
#   $fields{dis}{interactvariation}{label}             = 'Interacting Variation';
#   $fields{dis}{interactvariation}{tab}               = 'tab1';
#   $fields{dis}{interactvariation}{ontology_type}     = 'obo';
#   $fields{dis}{interactvariation}{ontology_table}    = 'variation';
#   $fields{dis}{interactgene}{type}                   = 'multiontology';
#   $fields{dis}{interactgene}{label}                  = 'Interacting Gene';
#   $fields{dis}{interactgene}{tab}                    = 'tab1';
#   $fields{dis}{interactgene}{ontology_type}          = 'WBGene';
#   $fields{dis}{interacttransgene}{type}              = 'multiontology';
#   $fields{dis}{interacttransgene}{label}             = 'Interacting Transgene';
#   $fields{dis}{interacttransgene}{tab}               = 'tab1';
#   $fields{dis}{interacttransgene}{ontology_type}     = 'Transgene';
#   $fields{dis}{rnaiexperiment}{type}                 = 'multiontology';
#   $fields{dis}{rnaiexperiment}{label}                = 'RNAi Experiment';
#   $fields{dis}{rnaiexperiment}{tab}                  = 'tab1';
#   $fields{dis}{rnaiexperiment}{ontology_type}        = 'WBRnai';
#   $fields{dis}{modelremark}{type}                    = 'bigtext';
#   $fields{dis}{modelremark}{label}                   = 'Model Remark';
#   $fields{dis}{modelremark}{tab}                     = 'tab1';
#   $fields{dis}{modelremark}{cols_size}               = '100';
  $fields{dis}{assertedgene}{type}                   = 'multiontology';
  $fields{dis}{assertedgene}{label}                  = 'Asserted Gene';
  $fields{dis}{assertedgene}{tab}                    = 'tab1';
  $fields{dis}{assertedgene}{ontology_type}          = 'WBGene';
  $fields{dis}{assertedvariation}{type}              = 'multiontology';
  $fields{dis}{assertedvariation}{label}             = 'Asserted Variation';
  $fields{dis}{assertedvariation}{tab}               = 'tab1';
  $fields{dis}{assertedvariation}{ontology_type}     = 'obo';
  $fields{dis}{assertedvariation}{ontology_table}    = 'variation';
  $fields{dis}{assertedhumangene}{type}              = 'ontology';
  $fields{dis}{assertedhumangene}{label}             = 'Asserted Human Gene';
  $fields{dis}{assertedhumangene}{tab}               = 'tab1';
  $fields{dis}{assertedhumangene}{ontology_type}     = 'obo';
  $fields{dis}{assertedhumangene}{ontology_table}    = 'hgnc';
  $fields{dis}{associationtype}{type}                = 'dropdown';
  $fields{dis}{associationtype}{label}               = 'Association Type';
  $fields{dis}{associationtype}{tab}                 = 'tab1';
  $fields{dis}{associationtype}{dropdown_type}       = 'disassociationtype';
  $fields{dis}{eco}{type}                            = 'multiontology';
  $fields{dis}{eco}{label}                           = 'ECO Term';
  $fields{dis}{eco}{tab}                             = 'tab1';
  $fields{dis}{eco}{ontology_type}                   = 'obo';
  $fields{dis}{eco}{ontology_table}                  = 'eco';
  $fields{dis}{goinference}{type}                    = 'multidropdown';
  $fields{dis}{goinference}{label}                   = 'Evidence Code';
  $fields{dis}{goinference}{tab}                     = 'tab1';
  $fields{dis}{goinference}{dropdown_type}           = 'goinference';
  $fields{dis}{qualifier}{type}                      = 'dropdown';
  $fields{dis}{qualifier}{label}                     = 'Qualifier';
  $fields{dis}{qualifier}{tab}                       = 'tab1';
  $fields{dis}{qualifier}{dropdown_type}             = 'disqualifier';
  $fields{dis}{geneticsex}{type}                     = 'dropdown';
  $fields{dis}{geneticsex}{label}                    = 'Genetic Sex';
  $fields{dis}{geneticsex}{tab}                      = 'tab1';
  $fields{dis}{geneticsex}{dropdown_type}            = 'disgeneticsex';
  $fields{dis}{paperexpmod}{type}                    = 'multiontology';
  $fields{dis}{paperexpmod}{label}                   = 'Reference';
  $fields{dis}{paperexpmod}{tab}                     = 'tab1';
  $fields{dis}{paperexpmod}{ontology_type}           = 'WBPaper';
  $fields{dis}{diseasemodeldesc}{type}               = 'textarea';
  $fields{dis}{diseasemodeldesc}{label}              = 'Disease Model Description';
  $fields{dis}{diseasemodeldesc}{tab}                = 'tab1';
  $fields{dis}{diseasemodeldesc}{cols_size}          = '60';
  $fields{dis}{diseasemodeldesc}{rows_size}          = '7';
  $fields{dis}{lastupdateexpmod}{type}               = 'text';
  $fields{dis}{lastupdateexpmod}{label}              = 'Date Last Updated';
  $fields{dis}{lastupdateexpmod}{tab}                = 'tab1';
  $fields{dis}{comment}{type}                        = 'bigtext';
  $fields{dis}{comment}{label}                       = 'Comment';
  $fields{dis}{comment}{tab}                         = 'tab1';
  $fields{dis}{comment}{cols_size}                   = '100';
# DELETE THIS TABLE LATER
#   $fields{dis}{molecule}{type}                       = 'ontology';
#   $fields{dis}{molecule}{label}                      = 'Molecule';
#   $fields{dis}{molecule}{tab}                        = 'tab2';
#   $fields{dis}{molecule}{ontology_type}              = 'Molecule';
  $fields{dis}{inducingchemical}{type}               = 'multiontology';
  $fields{dis}{inducingchemical}{label}              = 'Inducing Chemical';
  $fields{dis}{inducingchemical}{tab}                = 'tab2';
  $fields{dis}{inducingchemical}{ontology_type}      = 'Molecule';
  $fields{dis}{inducingagent}{type}                  = 'text';
  $fields{dis}{inducingagent}{label}                 = 'Inducing Agent';
  $fields{dis}{inducingagent}{tab}                   = 'tab2';
  $fields{dis}{commentexpcond}{type}                 = 'bigtext';
  $fields{dis}{commentexpcond}{label}                = 'Experimental Condition Comment';
  $fields{dis}{commentexpcond}{tab}                  = 'tab2';
  $fields{dis}{modtransgene}{type}                   = 'multiontology';
  $fields{dis}{modtransgene}{label}                  = 'Modifier Transgene';
  $fields{dis}{modtransgene}{tab}                    = 'tab2';
  $fields{dis}{modtransgene}{ontology_type}          = 'Transgene';
  $fields{dis}{modvariation}{type}                   = 'multiontology';
  $fields{dis}{modvariation}{label}                  = 'Modifier Variation';
  $fields{dis}{modvariation}{tab}                    = 'tab2';
  $fields{dis}{modvariation}{ontology_type}          = 'obo';
  $fields{dis}{modvariation}{ontology_table}         = 'variation';
  $fields{dis}{modstrain}{type}                      = 'multiontology';
  $fields{dis}{modstrain}{label}                     = 'Modifier Strain';
  $fields{dis}{modstrain}{tab}                       = 'tab2';
  $fields{dis}{modstrain}{ontology_type}             = 'obo';
  $fields{dis}{modstrain}{ontology_table}            = 'strain';
  $fields{dis}{modgene}{type}                        = 'multiontology';
  $fields{dis}{modgene}{label}                       = 'Modifier Gene';
  $fields{dis}{modgene}{tab}                         = 'tab2';
  $fields{dis}{modgene}{ontology_type}               = 'WBGene';
  $fields{dis}{modhumangene}{type}                   = 'multiontology';
  $fields{dis}{modhumangene}{label}                  = 'Inferred Modifier Human Gene';
  $fields{dis}{modhumangene}{tab}                    = 'tab2';
  $fields{dis}{modhumangene}{ontology_type}          = 'obo';
  $fields{dis}{modhumangene}{ontology_table}         = 'hgnc';
  $fields{dis}{modgenotype}{type}                    = 'ontology';
  $fields{dis}{modgenotype}{label}                   = 'Modifier Genotype';
  $fields{dis}{modgenotype}{tab}                     = 'tab2';
  $fields{dis}{modgenotype}{ontology_type}           = 'WBGenotype';
  $fields{dis}{modmolecule}{type}                    = 'multiontology';
  $fields{dis}{modmolecule}{label}                   = 'Modifier Molecule';
  $fields{dis}{modmolecule}{tab}                     = 'tab2';
  $fields{dis}{modmolecule}{ontology_type}           = 'Molecule';
  $fields{dis}{modother}{type}                       = 'bigtext';
  $fields{dis}{modother}{label}                      = 'Other Modifier';
  $fields{dis}{modother}{tab}                        = 'tab2';
  $fields{dis}{moleculetype}{type}                   = 'dropdown';
  $fields{dis}{moleculetype}{label}                  = 'Modifier Association Type';
  $fields{dis}{moleculetype}{tab}                    = 'tab2';
  $fields{dis}{moleculetype}{dropdown_type}          = 'dismoleculetype';
  $fields{dis}{modqualifier}{type}                   = 'dropdown';
  $fields{dis}{modqualifier}{label}                  = 'Modifier Qualifier';
  $fields{dis}{modqualifier}{tab}                    = 'tab2';
  $fields{dis}{modqualifier}{dropdown_type}          = 'dismodqualifier';
#   $fields{dis}{phenotypedisease}{type}               = 'multiontology';
#   $fields{dis}{phenotypedisease}{label}              = 'Disease Phenotype';
#   $fields{dis}{phenotypedisease}{tab}                = 'tab2';
#   $fields{dis}{phenotypedisease}{ontology_type}      = 'obo';
#   $fields{dis}{phenotypedisease}{ontology_table}     = 'phenotype';
#   $fields{dis}{phenotypeameliorated}{type}           = 'multiontology';
#   $fields{dis}{phenotypeameliorated}{label}          = 'Ameliorated Phenotype';
#   $fields{dis}{phenotypeameliorated}{tab}            = 'tab2';
#   $fields{dis}{phenotypeameliorated}{ontology_type}  = 'obo';
#   $fields{dis}{phenotypeameliorated}{ontology_table} = 'phenotype';
#   $fields{dis}{phenotypeexacerbated}{type}           = 'multiontology';
#   $fields{dis}{phenotypeexacerbated}{label}          = 'Exacerbated Phenotype';
#   $fields{dis}{phenotypeexacerbated}{tab}            = 'tab2';
#   $fields{dis}{phenotypeexacerbated}{ontology_type}  = 'obo';
#   $fields{dis}{phenotypeexacerbated}{ontology_table} = 'phenotype';
# # DELETE THIS TABLE LATER 
# #   $fields{dis}{phenotypeaffected}{type}              = 'multiontology';
# #   $fields{dis}{phenotypeaffected}{label}             = 'Affected Phenotype';
# #   $fields{dis}{phenotypeaffected}{tab}               = 'tab2';
# #   $fields{dis}{phenotypeaffected}{ontology_type}     = 'obo';
# #   $fields{dis}{phenotypeaffected}{ontology_table}    = 'phenotype';
#   $fields{dis}{commentdisphen}{type}                 = 'bigtext';
#   $fields{dis}{commentdisphen}{label}                = 'Disease Phenotype Comment';
#   $fields{dis}{commentdisphen}{tab}                  = 'tab2';
  $fields{dis}{diseaserelevance}{type}               = 'textarea';
  $fields{dis}{diseaserelevance}{label}              = 'Disease Relevance Description';
  $fields{dis}{diseaserelevance}{tab}                = 'tab2';
  $fields{dis}{diseaserelevance}{cols_size}          = '60';
  $fields{dis}{diseaserelevance}{rows_size}          = '7';
  $fields{dis}{paperdisrel}{type}                    = 'multiontology';
  $fields{dis}{paperdisrel}{label}                   = 'Paper for Disease Relevance';
  $fields{dis}{paperdisrel}{tab}                     = 'tab2';
  ...
  $fields{dis}{lastupdatedisrel}{tab}                = 'tab2';
  $fields{dis}{genedisrel}{type}                     = 'text';
  $fields{dis}{genedisrel}{label}                    = 'OMIM Gene';
  $fields{dis}{genedisrel}{tab}                      = 'tab2';
  $fields{dis}{dbexpmod}{type}                       = 'text';
  $fields{dis}{dbexpmod}{label}                      = 'OMIM Disease';
  $fields{dis}{dbexpmod}{tab}                        = 'tab2';
  $fields{dis}{dbdisrel}{type}                       = 'text';
  $fields{dis}{dbdisrel}{label}                      = 'OMIM disease for Disease Rel';
  $fields{dis}{dbdisrel}{tab}                        = 'tab2';
#   $fields{dis}{suggested_phenotype}{type}            = 'text';
#   $fields{dis}{suggested_phenotype}{label}           = 'Requested Phenotype';
#   $fields{dis}{suggested_phenotype}{tab}             = 'tab2';
#   $fields{dis}{suggested_definition}{type}           = 'bigtext';
#   $fields{dis}{suggested_definition}{label}          = 'Requested Phenotype Definition';
#   $fields{dis}{suggested_definition}{tab}            = 'tab2';
#   $fields{dis}{child_of}{type}                       = 'multiontology';
#   $fields{dis}{child_of}{label}                      = 'Child Of Phenotype';
#   $fields{dis}{child_of}{tab}                        = 'tab2';
#   $fields{dis}{child_of}{ontology_type}              = 'obo';
#   $fields{dis}{child_of}{ontology_table}             = 'phenotype';
  ...
  $datatypes{dis}{constraintSub}                     = \&checkDisConstraints;
  @{ $datatypes{dis}{constraintTablesHaveData} }     = qw( curator humandoid associationtype goinference geneticsex paperexpmod lastupdateexpmod species );
  @{ $datatypes{dis}{highestPgidTables} }            = qw( curator humandoid );
  return( \%fields, \%datatypes);
} # sub initWormDisFields
...
sub initWormDitFields {
  ...
  $fields{dit}{curator}{tab}                         = 'tab1';
  $fields{dit}{curator}{dropdown_type}               = 'curator';
  $fields{dit}{curhistory}{type}                     = 'ontology';
  $fields{dit}{curhistory}{label}                    = 'Curator History';
  $fields{dit}{curhistory}{tab}                      = 'tab1';
  $fields{dit}{curhistory}{ontology_type}            = 'Ditcurhst';
  $fields{dit}{distermmodeltype}{type}               = 'dropdown';
  $fields{dit}{distermmodeltype}{label}              = 'Model_type';
  $fields{dit}{distermmodeltype}{tab}                = 'tab1';
  $fields{dit}{distermmodeltype}{dropdown_type}      = 'distermmodeltype';
  $fields{dit}{variation}{type}                      = 'multiontology';
  $fields{dit}{variation}{label}                     = 'Variation';
  $fields{dit}{variation}{tab}                       = 'all';
  $fields{dit}{variation}{ontology_type}             = 'obo';
  $fields{dit}{variation}{ontology_table}            = 'variation';
  $fields{dit}{transgene}{type}                      = 'multiontology';
  $fields{dit}{transgene}{label}                     = 'Transgene';
  $fields{dit}{transgene}{tab}                       = 'all';
  $fields{dit}{transgene}{ontology_type}             = 'Transgene';
  $fields{dit}{strain}{type}                         = 'ontology';
  $fields{dit}{strain}{label}                        = 'Strain';
  $fields{dit}{strain}{tab}                          = 'all';
  $fields{dit}{strain}{ontology_type}                = 'obo';
  $fields{dit}{strain}{ontology_table}               = 'strain';
  $fields{dit}{phenotypedisease}{type}               = 'multiontology';
  $fields{dit}{phenotypedisease}{label}              = 'Disease Phenotype';
  $fields{dit}{phenotypedisease}{tab}                = 'tab1';
  $fields{dit}{phenotypedisease}{ontology_type}      = 'obo';
  $fields{dit}{phenotypedisease}{ontology_table}     = 'phenotype';
  $fields{dit}{phenotypediseasecomment}{type}        = 'bigtext';
  $fields{dit}{phenotypediseasecomment}{label}       = 'Disease Phenotype Comment';
  $fields{dit}{phenotypediseasecomment}{tab}         = 'tab1';
  $fields{dit}{phenotypediseasecomment}{cols_size}   = '100';
#   $fields{dit}{species}{type}                        = 'dropdown';
  $fields{dit}{species}{type}                        = 'ontology';
  $fields{dit}{species}{label}                       = 'Species';
  $fields{dit}{species}{tab}                         = 'tab1';
#   $fields{dit}{species}{dropdown_type}               = 'species';
  $fields{dit}{species}{ontology_type}               = 'obo';
  $fields{dit}{species}{ontology_table}              = 'species';
  $fields{dit}{goinference}{type}                    = 'dropdown';
  $fields{dit}{goinference}{label}                   = 'Evidence Code';
  $fields{dit}{goinference}{tab}                     = 'tab1';
  $fields{dit}{goinference}{dropdown_type}           = 'goinference';
  $fields{dit}{wormmodeldesc}{type}                  = 'textarea';
  $fields{dit}{wormmodeldesc}{label}                 = 'Worm Model Description';
  $fields{dit}{wormmodeldesc}{tab}                   = 'tab1';
...
# distermmodeltype strain goinference omimdisease omimgene othertreatment phenotypeaffectedcomment 
  $fields{dit}{omimdisease}{type}                    = 'text';
  $fields{dit}{omimdisease}{label}                   = 'OMIM Disease';
  $fields{dit}{omimdisease}{tab}                     = 'tab1';
  $fields{dit}{omimgene}{type}                       = 'text';
  $fields{dit}{omimgene}{label}                      = 'OMIM Gene';
  $fields{dit}{omimgene}{tab}                        = 'tab1';
  $fields{dit}{lastupdate}{type}                     = 'text';
  $fields{dit}{lastupdate}{label}                    = 'Last Updated';
  $fields{dit}{lastupdate}{tab}                      = 'tab1';
  $fields{dit}{comment}{type}                        = 'bigtext';
  $fields{dit}{comment}{label}                       = 'Comment';
  $fields{dit}{comment}{tab}                         = 'tab1';
  $fields{dit}{comment}{cols_size}                   = '100';
  $fields{dit}{moleculetype}{type}                   = 'dropdown';
  $fields{dit}{moleculetype}{label}                  = 'Molecule Type';
  $fields{dit}{moleculetype}{tab}                    = 'tab2';
  $fields{dit}{moleculetype}{dropdown_type}          = 'dismoleculetype';
  $fields{dit}{molecule}{type}                       = 'ontology';
  $fields{dit}{molecule}{label}                      = 'Molecule';
  $fields{dit}{molecule}{tab}                        = 'tab2';
  $fields{dit}{molecule}{ontology_type}              = 'Molecule';
  $fields{dit}{othertreatment}{type}                 = 'text';
  $fields{dit}{othertreatment}{label}                = 'Other Treatment';
  $fields{dit}{othertreatment}{tab}                  = 'tab2';
  $fields{dit}{phenotypeaffected}{type}              = 'multiontology';
  $fields{dit}{phenotypeaffected}{label}             = 'Affected Phenotype';
  $fields{dit}{phenotypeaffected}{tab}               = 'tab2';
  $fields{dit}{phenotypeaffected}{ontology_type}     = 'obo';
  $fields{dit}{phenotypeaffected}{ontology_table}    = 'phenotype';
  $fields{dit}{phenotypeaffectedcomment}{type}       = 'bigtext';
  $fields{dit}{phenotypeaffectedcomment}{label}      = 'Affected Phenotype Comment';
  $fields{dit}{phenotypeaffectedcomment}{tab}        = 'tab2';
  $fields{dit}{phenotypeaffectedcomment}{cols_size}  = '100';
  $fields{dit}{suggested_phenotype}{type}            = 'text';
  $fields{dit}{suggested_phenotype}{label}           = 'Suggested Phenotype';
  $fields{dit}{suggested_phenotype}{tab}             = 'tab3';
  $fields{dit}{suggested_definition}{type}           = 'bigtext';
  $fields{dit}{suggested_definition}{label}          = 'Suggested Phenotype Definition';
  $fields{dit}{suggested_definition}{tab}            = 'tab3';
  $fields{dit}{child_of}{type}                       = 'multiontology';
  $fields{dit}{child_of}{label}                      = 'Child Of Phenotype';
  $fields{dit}{child_of}{tab}                        = 'tab3';
  $fields{dit}{child_of}{ontology_type}              = 'obo';
  $fields{dit}{child_of}{ontology_table}             = 'phenotype';
  $fields{dit}{suggested_strain}{type}               = 'bigtext';
  $fields{dit}{suggested_strain}{label}              = 'Suggested Strain';
  $fields{dit}{suggested_strain}{tab}                = 'tab3';
...
sub initWormGnoFields {
  my ($datatype, $curator_two) = @_;
  my %fields; my %datatypes;
  tie %{ $fields{gno} }, "Tie::IxHash";
  @{ $datatypes{gno}{highestPgidTables} }            = qw( name curator );
  $fields{gno}{id}{type}                             = 'text';
  $fields{gno}{id}{label}                            = 'pgid';
  $fields{gno}{id}{tab}                              = 'tab1';
  $fields{gno}{identifier}{type}                     = 'text';
  $fields{gno}{identifier}{label}                    = 'ID';
  $fields{gno}{identifier}{tab}                      = 'tab1';
  $fields{gno}{curator}{type}                        = 'dropdown';
  $fields{gno}{curator}{label}                       = 'Curator';
  $fields{gno}{curator}{tab}                         = 'tab1';
  $fields{gno}{curator}{dropdown_type}               = 'curator';
  $fields{gno}{name}{type}                           = 'bigtext';
  $fields{gno}{name}{label}                          = 'Name';
  $fields{gno}{name}{tab}                            = 'tab1';
  $fields{gno}{synonym}{type}                        = 'bigtext';
  $fields{gno}{synonym}{label}                       = 'Synonym';
  $fields{gno}{synonym}{tab}                         = 'tab1';
  $fields{gno}{gene}{type}                           = 'multiontology';
  $fields{gno}{gene}{label}                          = 'Gene';
  $fields{gno}{gene}{tab}                            = 'tab1';
  $fields{gno}{gene}{ontology_type}                  = 'WBGene';
  $fields{gno}{variation}{type}                      = 'multiontology';
  $fields{gno}{variation}{label}                     = 'Variation';
  $fields{gno}{variation}{tab}                       = 'tab1';
  $fields{gno}{variation}{ontology_type}             = 'obo';
  $fields{gno}{variation}{ontology_table}            = 'variation';
  $fields{gno}{rearrangement}{type}                  = 'multiontology';
  $fields{gno}{rearrangement}{label}                 = 'Rearrangement';
  $fields{gno}{rearrangement}{tab}                   = 'tab1';
  $fields{gno}{rearrangement}{ontology_type}         = 'obo';
  $fields{gno}{rearrangement}{ontology_table}        = 'rearrangement';
  $fields{gno}{transgene}{type}                      = 'multiontology';
  $fields{gno}{transgene}{label}                     = 'Transgene';
  $fields{gno}{transgene}{tab}                       = 'tab1';
  $fields{gno}{transgene}{ontology_type}             = 'Transgene';
  $fields{gno}{hgnc}{type}                           = 'multiontology';
  $fields{gno}{hgnc}{label}                          = 'Human Gene';
  $fields{gno}{hgnc}{tab}                            = 'tab1';
  $fields{gno}{hgnc}{ontology_type}                  = 'obo';
  $fields{gno}{hgnc}{ontology_table}                 = 'hgnc';
  $fields{gno}{othercomp}{type}                      = 'bigtext';
  $fields{gno}{othercomp}{label}                     = 'Other Component';
  $fields{gno}{othercomp}{tab}                       = 'tab1';
  $fields{gno}{species}{type}                        = 'ontology';
  $fields{gno}{species}{label}                       = 'Species';
  $fields{gno}{species}{tab}                         = 'tab1';
  $fields{gno}{species}{ontology_type}               = 'obo';
  $fields{gno}{species}{ontology_table}              = 'species';
  $fields{gno}{remark}{type}                         = 'bigtext';
  $fields{gno}{remark}{label}                        = 'Remark';
  $fields{gno}{remark}{tab}                          = 'tab1';
  $fields{gno}{paper}{type}                          = 'multiontology';
  $fields{gno}{paper}{label}                         = 'Paper';
  $fields{gno}{paper}{tab}                           = 'tab1';
  $fields{gno}{paper}{ontology_type}                 = 'WBPaper';
  $fields{gno}{nodump}{type}                         = 'toggle';
  $fields{gno}{nodump}{label}                        = 'NO DUMP';
  $fields{gno}{nodump}{tab}                          = 'tab1';
  $datatypes{gno}{newRowSub}                         = \&newRowGno;
  $datatypes{gno}{label}                             = 'genotype';
  return( \%fields, \%datatypes);
}
...
sub initWormGrgFields {
  ...
  $fields{grg}{othermethod_text}{label}              = 'Other Method';
...
#   $fields{grg}{transregulatedseq}{ontology_type}     = 'WBSequence';
  ...
  $fields{grg}{anatomy}{type}                        = 'multiontology';
  $fields{grg}{anatomy}{label}                       = 'Anatomy';
  $fields{grg}{anatomy}{tab}                         = 'tab4';
  $fields{grg}{anatomy}{ontology_type}               = 'obo';
  $fields{grg}{anatomy}{ontology_table}              = 'anatomy';
  $fields{grg}{lifestage}{type}                      = 'multiontology';
  $fields{grg}{lifestage}{label}                     = 'Life Stage';
  $fields{grg}{lifestage}{tab}                       = 'tab4';
  $fields{grg}{lifestage}{ontology_type}             = 'obo';
  $fields{grg}{lifestage}{ontology_table}            = 'lifestage';
  $fields{grg}{scl}{type}                            = 'toggle_text';
  $fields{grg}{scl}{label}                           = 'SCL';
  $fields{grg}{scl}{tab}                             = 'tab4';
  $fields{grg}{scl}{inline}                          = 'scltext';
  $fields{grg}{scltext}{type}                        = 'text';
  $fields{grg}{scltext}{label}                       = 'SCL Text';
  $fields{grg}{scltext}{tab}                         = 'tab4';
  $fields{grg}{scltext}{inline}                      = 'INSIDE_scltext';
...
#   $fields{grg}{not_scltext}{inline}                  = 'INSIDE_not_scltext';
  ...
  $fields{grg}{result}{label}                        = 'Regulation Result';
...
#   $fields{int}{nondirectional}{tab}                  = 'tab1';
  ...
  $fields{int}{gimoduleone}{type}                    = 'dropdown';
  $fields{int}{gimoduleone}{label}                   = 'GI Module 1';
  $fields{int}{gimoduleone}{tab}                     = 'tab1';
  $fields{int}{gimoduleone}{dropdown_type}           = 'intgimodone';
  $fields{int}{gimoduletwo}{type}                    = 'dropdown';
  $fields{int}{gimoduletwo}{label}                   = 'GI Module 2';
  $fields{int}{gimoduletwo}{tab}                     = 'tab1';
  $fields{int}{gimoduletwo}{dropdown_type}           = 'intgimodtwo';
  $fields{int}{gimodulethree}{type}                  = 'dropdown';
  $fields{int}{gimodulethree}{label}                 = 'GI Module 3';
  $fields{int}{gimodulethree}{tab}                   = 'tab1';
  $fields{int}{gimodulethree}{dropdown_type}         = 'intgimodthree';
  ...
  $fields{int}{laboratory}{ontology_type}            = 'Laboratory';
...
#   $fields{int}{transgenetwogene}{ontology_type}      = 'WBGene';
  ...
  $fields{int}{communitycurator}{type}               = 'ontology';
  $fields{int}{communitycurator}{label}              = 'Community Curator';
  $fields{int}{communitycurator}{tab}                = 'tab5';
  $fields{int}{communitycurator}{ontology_type}      = 'WBPerson';
  $fields{int}{communitycuratoremail}{type}          = 'text';
  $fields{int}{communitycuratoremail}{label}         = 'Community Curator Email';
  $fields{int}{communitycuratoremail}{tab}           = 'tab5';
  $fields{int}{needsreview}{type}                    = 'toggle';
  $fields{int}{needsreview}{label}                   = 'Needs Review';
  $fields{int}{needsreview}{tab}                     = 'tab5';
...
#   $fields{mop}{essentialfor}{ontology_type}            = 'Papspecies';
  ...
  $fields{mop}{endogenousin}{ontology_type}            = 'Papspecies';
#   $fields{mop}{endogenousin}{ontology_type}            = 'obo';
#   $fields{mop}{endogenousin}{ontology_table}           = 'ncbitaxonid';

  $fields{mop}{communitycurator}{type}               = 'ontology';
  $fields{mop}{communitycurator}{label}              = 'Community Curator';
  $fields{mop}{communitycurator}{tab}                = 'tab3';
  $fields{mop}{communitycurator}{ontology_type}      = 'WBPerson';
  $fields{mop}{communitycuratoremail}{type}          = 'text';
  $fields{mop}{communitycuratoremail}{label}         = 'Community Curator Email';
  $fields{mop}{communitycuratoremail}{tab}           = 'tab3';
...
#   $fields{pic}{species}{type}                        = 'dropdown';
  ...
  $fields{pic}{species}{ontology_type}               = 'Papspecies';
...
#   $fields{pro}{goid}{ontology_table}                 = 'goid';
  ...
  $fields{pro}{taxon}{ontology_type}                 = 'Papspecies';
...
#   $fields{rna}{date}{tab}                            = 'tab1';
  ...
  $fields{rna}{dnatext}{maxAutoWidth}                = '500';
...
#   $fields{rna}{species}{dropdown_type}               = 'species';
  ...
  $fields{rna}{pathogen}{type}                       = 'multiontology';
  $fields{rna}{pathogen}{label}                      = 'Affected By Pathogen';
  $fields{rna}{pathogen}{tab}                        = 'tab2';
  $fields{rna}{pathogen}{ontology_type}              = 'Papspecies';
...
#   $fields{rna}{phenotypenot}{ontology_table}         = 'phenotype';
  ...
  $fields{rna}{micropublication}{type}               = 'toggle';
  $fields{rna}{micropublication}{label}              = 'Micropublication';
  $fields{rna}{micropublication}{tab}                = 'tab4';
...
#   $fields{trp}{integration_method}{dropdown_type}    = 'integrationmethod';
  ...
  $fields{trp}{laboratory}{ontology_type}            = 'Laboratory';
  $fields{trp}{strain}{type}                         = 'multiontology';
  $fields{trp}{strain}{label}                        = 'Strain';
  $fields{trp}{strain}{tab}                          = 'tab2';
  $fields{trp}{strain}{ontology_type}                = 'obo';
  $fields{trp}{strain}{ontology_table}               = 'strain';
...
#   $fields{trp}{species}{ontology_type}               = 'Papspecies';
...
sub getHighestExprId {		# look at all exp_name, get the highest number and return
  ...
  return $highest; }
sub getHighestGnoId {		# look at all gno_identifier, get the highest number and return
  my $highest = 0;
  my $result = $dbh->prepare( "SELECT gno_identifier FROM gno_identifier WHERE gno_identifier ~ '^WBGenotype'" ); $result->execute(); 
  while (my @row = $result->fetchrow()) { if ($row[0]) { $row[0] =~ s/WBGenotype//; if ($row[0] > $highest) { $highest = $row[0]; } } }
  return $highest; }
...
sub newRowAbp {
  ...
  if ($returnValue eq 'OK') {
    my $abpId = &pad8Zeros($newPgid);
    ($returnValue)  = &insertToPostgresTableAndHistory('abp_name', $newPgid, "WBAntibody$abpId"); }
...
#     unless ($returnValue eq 'OK') { $notOk .= $returnValue; }
    ...
    unless ($returnValue eq 'OK') { $notOk .= $returnValue; }
    ($returnValue)  = &insertToPostgresTableAndHistory('dis_species', $newPgid, 'Homo sapiens'); 
    unless ($returnValue eq 'OK') { $notOk .= $returnValue; }
    ($returnValue)  = &insertToPostgresTableAndHistory('dis_geneticsex', $newPgid, 'hermaphrodite'); 
    unless ($returnValue eq 'OK') { $notOk .= $returnValue; }
    ($returnValue)  = &insertToPostgresTableAndHistory('dis_eco', $newPgid, '"ECO:0007013"'); 
    unless ($returnValue eq 'OK') { $notOk .= $returnValue; }
    if ($notOk) { $returnValue = $notOk; } }
  if ($returnValue eq 'OK') { $returnValue = $newPgid; } 
  return $returnValue; }
...
sub newRowGno {
  my ($newPgid, $curator_two) = @_; my $curator = $curator_two; $curator =~ s/two/WBPerson/;
  my ($returnValue) = &insertToPostgresTableAndHistory('gno_curator', $newPgid, $curator);
  if ($returnValue eq 'OK') {
    my ($newGnoId) = &getHighestGnoId(); $newGnoId++;
    $newGnoId = &pad8Zeros($newGnoId); 
    ($returnValue)  = &insertToPostgresTableAndHistory('gno_identifier', $newPgid, "WBGenotype$newGnoId"); }
  if ($returnValue eq 'OK') {
    my $species = 'Caenorhabditis elegans';
    ($returnValue)  = &insertToPostgresTableAndHistory('gno_species', $newPgid, $species); }
  if ($returnValue eq 'OK') { $returnValue = $newPgid; } 
  return $returnValue; }
sub newRowGop {
  my ($newPgid, $curator_two) = @_; my $curator = $curator_two; $curator =~ s/two/WBPerson/;
...
sub checkDisConstraints {
  my ($allDataTableIds) = @_;
  my ($fieldsRef, $datatypesRef) = &initWormDisFields('dis', 'two1823');
  my %fields = %$fieldsRef;
  my @ids = split/,/, $allDataTableIds; my $joinkeys = join"','", @ids; 
  my $returnMessage = ""; my %hash;
  my @tables = qw( associationtype moleculetype );
  my @required_tables = qw( wbgene variation transgene strain genotype );
  my %required_tables; foreach (@required_tables) { $required_tables{$_}++; }
  my @modifier_tables = qw( modtransgene modvariation modstrain modgene modgenotype modmolecule modother );
  foreach my $table (@tables, @required_tables, @modifier_tables) {
    my $pgtable = 'dis_' . $table;
    my $result = $dbh->prepare( "SELECT * FROM $pgtable WHERE joinkey IN ('$joinkeys')" );
    $result->execute(); 
    while (my @row = $result->fetchrow()) { 
      if ($row[1]) { 
        if ($required_tables{$table}) { $hash{$row[0]}{required}++; }
        $hash{$row[0]}{$table} = $row[1]; } } }
  foreach my $pgid (@ids) {
    if ( ($hash{$pgid}{'associationtype'} eq 'is_model_of') && !( $hash{$pgid}{strain} || $hash{$pgid}{genotype}) ) {
      $returnMessage .= "$pgid has associationtype $hash{$pgid}{'associationtype'}, but neither strain nor genotype.<br/>\n"; }
    elsif ( ($hash{$pgid}{'associationtype'} eq 'is_implicated_in') && !( $hash{$pgid}{wbgene} || $hash{$pgid}{transgene} || $hash{$pgid}{variation}) ) {
      $returnMessage .= "$pgid has associationtype $hash{$pgid}{'associationtype'}, but neither wbgene, transgene, nor variation.<br/>\n"; }
    foreach my $modifier_table (@modifier_tables) {
      if ( ($hash{$pgid}{$modifier_table}) && !($hash{$pgid}{'moleculetype'}) ) {
        $returnMessage .= "$pgid has $fields{dis}{$modifier_table}{label} but not modifier association type.<br/>\n"; } }
    unless ($hash{$pgid}{required}) { $returnMessage .= "$pgid has neither wbgene, strain, transgene, genotype, nor variation.<br/>\n"; } }
...
sub setAnySimpleAutocompleteValues {
  ...
  if ($ontology_type eq 'curator') {
    ...
    $data{$ontology_type}{name}{"Jae Cho"}                = "Jae Cho ( WBPerson38423 ) ";
    ...
    $data{$ontology_type}{name}{"Marie-Claire Harrison"}  = "Marie-Claire Harrison ( WBPerson42118 ) ";
    $data{$ontology_type}{name}{"Kevin Howe"}             = "Kevin Howe ( WBPerson3111 ) ";
    $data{$ontology_type}{name}{"April Jauhal"}           = "April Jauhal ( WBPerson40194 ) ";
    ...
    $data{$ontology_type}{name}{"Shayda Maher"}           = "Shayda Maher ( WBPerson38202 ) ";
...
#     $data{$ontology_type}{name}{"Human_disease_relevance"}         = "Human_disease_relevance";	# moved to disease OA  2013 01 25
  ...
  elsif ($ontology_type eq 'disassociationtype') {
    $data{$ontology_type}{name}{"is_model_of"}                     = "is_model_of";
#     $data{$ontology_type}{name}{"causes_or_contributes_to_condition"} = "causes_or_contributes_to_condition";
#     $data{$ontology_type}{name}{"causes_condition"}                   = "causes_condition";
#     $data{$ontology_type}{name}{"contributes_to_condition"}           = "contributes_to_condition";
    $data{$ontology_type}{name}{"is_marker_for"}                   = "is_marker_for";
    $data{$ontology_type}{name}{"is_implicated_in"}                = "is_implicated_in";
    $data{$ontology_type}{name}{"is_ameliorated_model_of"}         = "is_ameliorated_model_of";
    $data{$ontology_type}{name}{"is_exacerbated_model_of"}         = "is_exacerbated_model_of"; }
  elsif ($ontology_type eq 'disgeneticsex') {
    $data{$ontology_type}{name}{"hermaphrodite"}                   = "hermaphrodite"; 
    $data{$ontology_type}{name}{"male"}                            = "male"; 
    $data{$ontology_type}{name}{"female"}                          = "female"; }
  elsif ($ontology_type eq 'disqualifier') {
    $data{$ontology_type}{name}{"Qualifier_not"}                   = "Qualifier_not"; }
  elsif ($ontology_type eq 'dismodqualifier') {
    $data{$ontology_type}{name}{"Modifier_qualifier_not"}          = "Modifier_qualifier_not"; }
    ...
    $data{$ontology_type}{name}{"located_in"}                  = "located_in";
    $data{$ontology_type}{name}{"acts_upstream_of_or_within"}  = "acts_upstream_of_or_within";
    ...
    tie %{ $data{$ontology_type}{name} }, "Tie::IxHash";
    $data{$ontology_type}{name}{"Physical - Physical"}                           = "Physical - Physical ( Physical ) ";
    $data{$ontology_type}{name}{"Physical - Protein-Protein"}                    = "Physical - Protein-Protein ( ProteinProtein ) ";
    $data{$ontology_type}{name}{"Physical - Protein-DNA"}                        = "Physical - Protein-DNA ( ProteinDNA ) ";
    $data{$ontology_type}{name}{"Physical - Protein-RNA"}                        = "Physical - Protein-RNA ( ProteinRNA ) ";
...
#     $data{$ontology_type}{name}{"No_interaction"}              = "Genetic - No_interaction";
  elsif ($ontology_type eq 'intgimodone') {
    tie %{ $data{$ontology_type}{name} }, "Tie::IxHash";
    $data{$ontology_type}{name}{"A_phenotypic"}                  = "A_phenotypic";
    $data{$ontology_type}{name}{"Mono_phenotypic"}               = "Mono_phenotypic";
    $data{$ontology_type}{name}{"Cis_phenotypic"}                = "Cis_phenotypic";
    $data{$ontology_type}{name}{"Iso_phenotypic"}                = "Iso_phenotypic";
    $data{$ontology_type}{name}{"Trans_phenotypic"}              = "Trans_phenotypic"; }
  elsif ($ontology_type eq 'intgimodtwo') {
    tie %{ $data{$ontology_type}{name} }, "Tie::IxHash";
    $data{$ontology_type}{name}{"Enhancing"}                     = "Enhancing";
    $data{$ontology_type}{name}{"Suppressing"}                   = "Suppressing";
    $data{$ontology_type}{name}{"Sub_suppressing"}               = "Sub_suppressing";
    $data{$ontology_type}{name}{"Inter_suppressing"}             = "Inter_suppressing";
    $data{$ontology_type}{name}{"Semi_suppressing"}              = "Semi_suppressing";
    $data{$ontology_type}{name}{"Co_suppressing"}                = "Co_suppressing";
    $data{$ontology_type}{name}{"All_suppressing"}               = "All_suppressing";
    $data{$ontology_type}{name}{"Super_suppressing"}             = "Super_suppressing";
    $data{$ontology_type}{name}{"Masking"}                       = "Masking"; }
  elsif ($ontology_type eq 'intgimodthree') {
    tie %{ $data{$ontology_type}{name} }, "Tie::IxHash";
    $data{$ontology_type}{name}{"Neutral"}                       = "Neutral";
    $data{$ontology_type}{name}{"Non_neutral"}                   = "Non_neutral";
    $data{$ontology_type}{name}{"Positive"}                      = "Positive";
    $data{$ontology_type}{name}{"Negative"}                      = "Negative";
    $data{$ontology_type}{name}{"Converging"}                    = "Converging";
    $data{$ontology_type}{name}{"Diverging"}                     = "Diverging"; }
...
#     $data{$ontology_type}{name}{"Mixed"}                            = "Mixed"; 
  ...
  elsif ($ontology_type eq 'distermmodeltype') {
    tie %{ $data{$ontology_type}{name} }, "Tie::IxHash";
    $data{$ontology_type}{name}{"Experimental"}               = "Experimental";
    $data{$ontology_type}{name}{"Predicted"}                  = "Predicted";
    $data{$ontology_type}{name}{"NOT_model"}                  = "NOT_model"; }
  elsif ($ontology_type eq 'dismoleculetype') {
    tie %{ $data{$ontology_type}{name} }, "Tie::IxHash";
    $data{$ontology_type}{name}{"condition_exacerbated_by"}   = "condition_exacerbated_by";
#     $data{$ontology_type}{name}{"Toxic"}                      = "Toxic";
#     $data{$ontology_type}{name}{"No_effect"}                  = "No_effect";
#     $data{$ontology_type}{name}{"Does_not_exacerbate"}        = "Does_not_exacerbate";
#     $data{$ontology_type}{name}{"Does_not_ameliorate"}        = "Does_not_ameliorate";
#     $data{$ontology_type}{name}{"Not_toxic"}                  = "Not_toxic"; 
    $data{$ontology_type}{name}{"condition_ameliorated_by"}   = "condition_ameliorated_by"; }
...
sub getAnySpecificAutocomplete {
  ...
  elsif ($ontology_type eq 'Laboratory') {      ($matches) = &getAnyLaboratoryAutocomplete($words); }
  elsif ($ontology_type eq 'Molecule') {        ($matches) = &getAnyMoleculeAutocomplete($words); }
  elsif ($ontology_type eq 'Papspecies') {      ($matches) = &getAnyPapspeciesAutocomplete($words); }
  elsif ($ontology_type eq 'Protein') {         ($matches) = &getAnyProteinAutocomplete($words); }
  ...
  elsif ($ontology_type eq 'WBGenotype') {      ($matches) = &getAnyWBGenotypeAutocomplete($words); }
...
#   my @tables = qw( abp_publicname abp_name );
#   foreach my $table (@tables) {
...
sub getAnyAntibodyAutocomplete {			# autocomplete on OA config that has multiple values per row
  my ($words) = @_;
  my $max_results = 20; if ($words =~ m/^.{5,}/) { $max_results = 500; }
  my %matches; my $t = tie %matches, "Tie::IxHash";	# could have multiple joinkeys, so need tied hash instead of normal array
  my @tables = qw( abp_publicname );
  foreach my $table (@tables) {
    my $result = $dbh->prepare( "SELECT abp_name.abp_name, ${table}.$table, abp_name.joinkey FROM abp_name, $table WHERE abp_name.joinkey = ${table}.joinkey AND LOWER(${table}.$table) ~ '^$words' ORDER BY ${table}.$table;" );
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { $matches{"$row[1] ( $row[0] ) "}++; }
    $result = $dbh->prepare( "SELECT abp_name.abp_name, ${table}.$table, abp_name.joinkey FROM abp_name, $table WHERE abp_name.joinkey = ${table}.joinkey AND LOWER(${table}.$table) ~ '$words' AND LOWER(${table}.$table) !~ '^$words' ORDER BY ${table}.$table;" );
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { $matches{"$row[1] ( $row[0] ) "}++; }
    last if (scalar keys %matches >= $max_results);
  } # foreach my $table (@tables)
  my $table = 'abp_name';				# can't name abp_name twice, so can't add that to generic @tables above
  my $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '^$words' ORDER BY $table;" );
  $result->execute();
  ...
  if (scalar keys %matches >= $max_results) { $t->Replace($max_results - 1, 'no value', 'more ...'); }
  my $matches = join"\n", keys %matches; return $matches;
} # sub sub getAnyAntibodyAutocomplete
...
sub getAnyLaboratoryAutocomplete {
  my ($words) = @_;
  my $max_results = 20; if ($words =~ m/^.{5,}/) { $max_results = 500; }
  my %matches; my $t = tie %matches, "Tie::IxHash";	# sorted hash to filter results
  my %invalidLabs;
  my $result = $dbh->prepare( "SELECT * FROM lab_status WHERE lab_status = 'Invalid'" ); $result->execute();
  while (my @row = $result->fetchrow()) { $invalidLabs{$row[0]}++; }
  my @tables = qw( lab_name );
  foreach my $table (@tables) {
    my $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '^$words' ORDER BY $table;" );	# match by start of name
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) {
      my $invalid = ''; if ($invalidLabs{$row[0]}) { $invalid = ' INVALID'; }
      $matches{"$row[2]$invalid ( $row[2] ) "}++; }
    $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '$words' ORDER BY $table;" );		# then match anywhere in the name
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) {
      my $invalid = ''; if ($invalidLabs{$row[0]}) { $invalid = ' INVALID'; }
      $matches{"$row[2]$invalid ( $row[2] ) "}++; }
    $result = $dbh->prepare( "SELECT two_standardname.two_standardname, two_pis.two_pis FROM two_standardname, two_pis WHERE LOWER(two_standardname.two_standardname) ~ '^$words' AND two_standardname.joinkey = two_pis.joinkey AND two_pis.two_pis ~ '[A-Z]' ORDER BY two_standardname.two_standardname" );	# match by start of name
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) {
      my $invalid = ''; if ($invalidLabs{$row[0]}) { $invalid = ' INVALID'; }
      $matches{"$row[0]$invalid ( $row[1] ) "}++; }
    $result = $dbh->prepare( "SELECT two_standardname.two_standardname, two_pis.two_pis FROM two_standardname, two_pis WHERE LOWER(two_standardname.two_standardname) ~ '$words' AND two_standardname.joinkey = two_pis.joinkey AND two_pis.two_pis ~ '[A-Z]' ORDER BY two_standardname.two_standardname" );	# then match anywhere in the name
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) {
      my $invalid = ''; if ($invalidLabs{$row[0]}) { $invalid = ' INVALID'; }
      $matches{"$row[0]$invalid ( $row[1] ) "}++; }
...
sub getAnyProteinAutocomplete {			# autocomplete on OA config that has multiple values per row
  my ($words) = @_;
  my $max_results = 20; if ($words =~ m/^.{5,}/) { $max_results = 500; }
  my %matches; my $t = tie %matches, "Tie::IxHash";	# could have multiple joinkeys, so need tied hash instead of normal array
  my $table = 'gin_protein';				
  my $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '^$words' ORDER BY $table;" );
  $result->execute();
  ...
  if (scalar keys %matches >= $max_results) { $t->Replace($max_results - 1, 'no value', 'more ...'); }
  my $matches = join"\n", keys %matches; return $matches;
} # sub sub getAnyProteinAutocomplete
...
#   my %matches; my $t = tie %matches, "Tie::IxHash";	# could have multiple joinkeys, so need tied hash instead of normal array
#   my %fail;
#   my $result = $dbh->prepare( "SELECT * FROM trp_objpap_falsepos WHERE trp_objpap_falsepos = 'Fail';" );
#   $result->execute();
#   while (my @row = $result->fetchrow()) { $fail{$row[0]}++; }
...
#   foreach my $table (@tables) {
#     my $result = $dbh->prepare( "SELECT trp_name.trp_name, ${table}.$table, trp_name.joinkey FROM trp_name, $table WHERE trp_name.joinkey = ${table}.joinkey AND LOWER(${table}.$table) ~ '^$words' ORDER BY ${table}.$table;" );
#     $result->execute();
#     while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { unless ($fail{$row[2]}) { $matches{"$row[1] ( $row[0] ) "}++; } }
#     $result = $dbh->prepare( "SELECT trp_name.trp_name, ${table}.$table, trp_name.joinkey FROM trp_name, $table WHERE trp_name.joinkey = ${table}.joinkey AND LOWER(${table}.$table) ~ '$words' AND LOWER(${table}.$table) !~ '^$words' ORDER BY ${table}.$table;" );
#     $result->execute();
#     while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { unless ($fail{$row[2]}) { $matches{"$row[1] ( $row[0] ) "}++; } }
#     last if (scalar keys %matches >= $max_results);
#   } # foreach my $table (@tables)
#   my $table = 'trp_name';				# can't name trp_name twice, so can't add that to generic @tables above
#   my $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '^$words' ORDER BY $table;" );
#   $result->execute();
#   while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { unless ($fail{$row[0]}) { $matches{"$row[1] ( $row[1] ) "}++; } }
#   $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '$words' AND LOWER($table) !~ '^$words' ORDER BY $table;" );
#   $result->execute();
#   while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { unless ($fail{$row[0]}) { $matches{"$row[1] ( $row[1] ) "}++; } }
#   if (scalar keys %matches >= $max_results) { $t->Replace($max_results - 1, 'no value', 'more ...'); }
...
sub getAnyTransgeneAutocomplete {			# autocomplete on OA config that has multiple values per row
  ...
  my $table = 'trp_name';				# can't name trp_name twice, so can't add that to generic @tables above
  my $result = $dbh->prepare( "SELECT trp_publicname.trp_publicname, ${table}.${table} FROM $table, trp_publicname WHERE trp_publicname.joinkey = ${table}.joinkey AND LOWER(${table}.${table}) ~ '^$words' ORDER BY ${table}.${table};" );
  $result->execute();
...
sub getAnyWBGenotypeAutocomplete {
  my ($words) = @_;
  my $max_results = 20; if ($words =~ m/^.{5,}/) { $max_results = 500; }
  my %matches; my $t = tie %matches, "Tie::IxHash";	# sorted hash to filter results
  my $table = 'gno_identifier';				# can't name gno_identifier twice, so can't add that to generic @tables below
  my $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '^$words' ORDER BY $table;" );
  $result->execute();
  while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { $matches{"$row[1] ( $row[1] ) "}++; }
  $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '$words' AND LOWER($table) !~ '^$words' ORDER BY $table;" );
  $result->execute();
  while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { $matches{"$row[1] ( $row[1] ) "}++; }
  my @tables = qw( gno_name gno_synonym);
  foreach my $table (@tables) {
    my $result = $dbh->prepare( "SELECT gno_identifier.gno_identifier, ${table}.$table FROM gno_identifier, $table WHERE gno_identifier.joinkey = ${table}.joinkey AND LOWER(${table}.$table) ~ '^$words' ORDER BY ${table}.$table;" );
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { $matches{"$row[1] ( $row[0] ) "}++; }
    $result = $dbh->prepare( "SELECT gno_identifier.gno_identifier, ${table}.$table FROM gno_identifier, $table WHERE gno_identifier.joinkey = ${table}.joinkey AND LOWER(${table}.$table) ~ '$words' AND LOWER(${table}.$table) !~ '^$words' ORDER BY ${table}.$table;" );
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) { $matches{"$row[1] ( $row[0] ) "}++; }
    last if (scalar keys %matches >= $max_results);
  } # foreach my $table (@tables)
...
sub getAnyPapspeciesAutocomplete {
  my ($words) = @_;
  my $max_results = 20; if ($words =~ m/^.{5,}/) { $max_results = 500; }
  my %matches; my $t = tie %matches, "Tie::IxHash";	# sorted hash to filter results
  my @tables = qw( pap_species_index );
  foreach my $table (@tables) {
    my $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '^$words' ORDER BY $table;" );
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) {
      my $id = $row[0]; $matches{"$row[1] ( $id ) "}++; }
    $result = $dbh->prepare( "SELECT * FROM $table WHERE LOWER($table) ~ '$words' AND LOWER($table) !~ '^$words' ORDER BY $table;" );
    $result->execute();
    while ( (my @row = $result->fetchrow()) && (scalar keys %matches < $max_results) ) {
      my $id = $row[0]; $matches{"$row[1] ( $id ) "}++; }
...
sub getAnySpecificValidValue {
  ...
  elsif ($ontology_type eq 'Laboratory') {      ($matches) = &getAnyLaboratoryValidValue($userValue); }
  elsif ($ontology_type eq 'Molecule') {        ($matches) = &getAnyMoleculeValidValue($userValue); }
  elsif ($ontology_type eq 'Papspecies') {      ($matches) = &getAnyPapspeciesValidValue($userValue); }
  elsif ($ontology_type eq 'Protein') {         ($matches) = &getAnyProteinValidValue($userValue); }
  ...
  elsif ($ontology_type eq 'WBGenotype') {      ($matches) = &getAnyWBGenotypeValidValue($userValue); }
...
sub getAnyLaboratoryValidValue {
  my ($userValue) = @_;
  my ($name, $value) = ('bad', 'bad');
  if ( $userValue =~ m/^(.*?) \( (.*?) \) $/ ) { ($name, $value) = $userValue =~ m/^(.*?) \( (.*?) \) $/; }
  my $table =  'lab_name';
  my $result = $dbh->prepare( "SELECT * FROM $table WHERE $table = '$value';" );
  $result->execute();
  my @row = $result->fetchrow();
...
sub getAnyPapspeciesValidValue {
  my ($userValue) = @_;
  my ($value, $joinkey) = ('bad', 'bad');
...
sub getAnyWBGenotypeValidValue {
  my ($userValue) = @_;
  my ($typed_term, $value) = ('bad', 'bad');
  if ( $userValue =~ m/^(.*?) \( (.*) \) $/ ) { ($typed_term, $value) = $userValue =~ m/^(.*?) \( (.*) \) $/; }
  my $table =  'gno_identifier';
  my $result = $dbh->prepare( "SELECT * FROM $table WHERE $table = '$value';" );
  $result->execute();
  my @row = $result->fetchrow();
  if ($row[0]) { return "true"; } 
...
sub getAnySpecificTermInfo {
  ...
  elsif ($ontology_type eq 'Laboratory') {      ($matches) = &getAnyLaboratoryTermInfo($userValue); }
  elsif ($ontology_type eq 'Molecule') {        ($matches) = &getAnyMoleculeTermInfo($userValue); }
  elsif ($ontology_type eq 'Papspecies') {      ($matches) = &getAnyPapspeciesTermInfo($userValue); }
  elsif ($ontology_type eq 'Protein') {         ($matches) = &getAnyProteinTermInfo($userValue); }
  ...
  elsif ($ontology_type eq 'WBGenotype') {      ($matches) = &getAnyWBGenotypeTermInfo($userValue); }
...
sub getAnyAntibodyTermInfo {		# get term info for molecule objects from mop_ tables
  ...
  my $name; my $publicname; my $origpub; my $laboratory;
  ...
  $result = $dbh->prepare( "SELECT * FROM abp_publicname WHERE joinkey = '$joinkey' ;" ); $result->execute(); 
...
sub getAnyLaboratoryTermInfo {
  my ($userValue) = @_;
  my $lab_name = $userValue; my $some_name; my $to_print;
  if ($userValue =~ m/(.*?) \( (.*?) \)/) { $some_name = $1; $lab_name = $2; } else { $lab_name = $userValue; }
  my $result = $dbh->prepare( "SELECT * FROM lab_name WHERE lab_name = '$lab_name' ORDER BY lab_timestamp DESC;" );
  $result->execute(); my @row = $result->fetchrow();
  my $joinkey = $row[0]; 
  if ($lab_name) { $to_print .= "id: $lab_name<br />\nname: $lab_name<br />\n"; }
  $result = $dbh->prepare( "SELECT * FROM two_standardname WHERE joinkey IN (SELECT joinkey FROM two_pis WHERE two_pis = '$lab_name');" );
  $result->execute(); while (my @row = $result->fetchrow) { if ($row[2]) { $to_print .= "Representative : $row[2]<br />\n"; } }
  $result = $dbh->prepare( "SELECT * FROM lab_alleledesignation WHERE joinkey = '$joinkey';" );
  $result->execute(); while (my @row = $result->fetchrow) { if ($row[2]) { $to_print .= "Allele_designation : $row[2]<br />\n"; } }
  $result = $dbh->prepare( "SELECT * FROM lab_straindesignation WHERE joinkey = '$joinkey';" );
  $result->execute(); while (my @row = $result->fetchrow) { if ($row[2]) { $to_print .= "Strain_designation : $row[2]<br />\n"; } }
  $result = $dbh->prepare( "SELECT * FROM lab_mail WHERE joinkey = '$joinkey' ORDER BY lab_order;" );
  $result->execute(); while (my @row = $result->fetchrow) { if ($row[2]) { $to_print .= "Mail : $row[2]<br />\n"; } }
  $result = $dbh->prepare( "SELECT * FROM lab_email WHERE joinkey = '$joinkey';" );
  $result->execute(); while (my @row = $result->fetchrow) { if ($row[2]) { 
    $to_print .= "email: <a href=\"javascript:void(0)\" onClick=\"window.open('mailto:$row[2]')\">$row[2]</a><br />\n"; } }
  my (@data) = split/\n/, $to_print;
  foreach my $data_line (@data) { $data_line =~ s/^(.*?):/<span style=\"font-weight: bold\">$1 : <\/span>/; }
  $to_print = join"\n", @data;
  return $to_print;
...
#   if ($userValue =~ m/\( (\d+) \)/) { $joinkey = $1; } else { $joinkey = $userValue; }	# when autocomplete had the pgid for molecules
  ...
  my %molecule_name; my %chemi; my %chebi;
  $result = $dbh->prepare( "SELECT * FROM mop_molecule WHERE joinkey IN (SELECT joinkey FROM mop_name WHERE mop_name = '$objId');" ); $result->execute(); 
  while (my @row = $result->fetchrow) { if ($row[0]) { $molecule_name{$row[1]}++; } }
  $result = $dbh->prepare( "SELECT * FROM mop_chemi WHERE joinkey IN (SELECT joinkey FROM mop_name WHERE mop_name = '$objId');" ); $result->execute(); 
  while (my @row = $result->fetchrow) { if ($row[0]) { $chemi{$row[1]}++; } }
  $result = $dbh->prepare( "SELECT * FROM mop_chebi WHERE joinkey IN (SELECT joinkey FROM mop_name WHERE mop_name = '$objId');" ); $result->execute(); 
...
#   $to_print .= "pgid: <span style=\"font-weight: bold\">$joinkey</span><br />\n";
  ...
  foreach my $molecule_name (sort keys %molecule_name) {
...
#     $to_print .= "CTD: <a href=\"http://ctd.mdibl.org/detail.go?type=chem&acc=$molecule_name\" target=\"new\">$molecule_name</a><br />\n";
    $to_print .= "CTD: <a href=\"https://ctdbase.org/detail.go?type=chem&acc=$molecule_name\" target=\"new\">$molecule_name</a><br />\n";
  ...
  foreach my $chebi (sort keys %chebi) {
    $to_print .= "ChEBI: <a href=\"http://www.ebi.ac.uk/chebi/advancedSearchFT.do?searchString=$chebi\" target=\"new\">$chebi</a><br />\n"; }
...
sub getAnyPapspeciesTermInfo {		# get term info for molecule objects from mop_ tables
  my ($userValue) = @_;
  my ($id, $value) = ('bad', 'bad');
  $id = $userValue;
  my $result = $dbh->prepare( "SELECT * FROM pap_species_index WHERE joinkey = '$id' ORDER BY pap_timestamp DESC;" );
  $result->execute(); my @row = $result->fetchrow(); if ($row[1]) { $value = $row[1]; }
  my $to_print = qq(id: $id<br />\nname: $value<br />\n);
  my (@data) = split/\n/, $to_print;
  foreach my $data_line (@data) { $data_line =~ s/^(.*?):/<span style=\"font-weight: bold\">$1 : <\/span>/; }
  $to_print = join"\n", @data;
  return $to_print;
} # sub getAnyPapspeciesTermInfo

sub getAnyProteinTermInfo {		# get term info for molecule objects from mop_ tables
  my ($userValue) = @_; my %joinkeys;
  my ($typed_term, $value) = ('bad', 'bad');
  if ( $userValue =~ m/^(.*?) \( (.*?) \) $/ ) { ($typed_term, $value) = $userValue =~ m/^(.*?) \( (.*?) \) $/; }
    else { $value = $userValue; }
  my $result = $dbh->prepare( "SELECT * FROM gin_protein WHERE gin_protein = '$value' ORDER BY gin_timestamp DESC;" );
  $result->execute(); while ( my @row = $result->fetchrow() ) { $joinkeys{$row[0]}++; }
  my $to_print = qq(name: <a href="http://www.wormbase.org/species/c_elegans/protein/$value" target="_blank">$value</a><br />\n);
  my (@data) = split/\n/, $to_print;
  foreach my $data_line (@data) { $data_line =~ s/^(.*?):/<span style=\"font-weight: bold\">$1 : <\/span>/; }
  $to_print = join"\n", @data;
  return $to_print;
} # sub getAnyProteinTermInfo
...
sub getAnyTransgeneTermInfo {
  ...
  $result = $dbh->prepare( "SELECT * FROM trp_objpap_falsepos WHERE joinkey = '$joinkeys' AND trp_objpap_falsepos = 'Fail';" );
  $result->execute(); 
  while (my @row = $result->fetchrow) {
    if ($row[0]) { 
      $to_print .= "status: <span style=\"color:red; font-weight:bold;\">Invalid transgene.</span><br />\n"; } }
...
#   if ($locus) { $to_print .= "locus: <a target=\"new\" href=\"$dev_link\">$locus</a><br />\n"; }
  my $wormbase_link = "http://www.wormbase.org/species/c_elegans/gene/WBGene$joinkey";
  ...
  $result = $dbh->prepare( "SELECT * FROM con_desctext WHERE joinkey IN (SELECT joinkey FROM con_wbgene WHERE con_wbgene ~ 'WBGene$joinkey') AND joinkey IN (SELECT joinkey FROM con_desctype WHERE con_desctype = 'Automated_description')" ); $result->execute(); @row = $result->fetchrow(); 
  if ($row[1]) { $to_print .= "Automated description: $row[1]<br />\n"; }
...
sub getAnyWBGenotypeTermInfo {
  my ($userValue) = @_; my %joinkeys;
  my ($typed_term, $value) = ('bad', 'bad');
  if ( $userValue =~ m/^(.*?) \( (.*?) \) $/ ) { ($typed_term, $value) = $userValue =~ m/^(.*?) \( (.*?) \) $/; }
    else { $value = $userValue; }
  my $result = $dbh->prepare( "SELECT * FROM gno_identifier WHERE gno_identifier = '$value' ORDER BY gno_timestamp DESC;" );
  $result->execute(); while ( my @row = $result->fetchrow() ) { $joinkeys{$row[0]}++; }
  my $joinkeys = join("','", keys %joinkeys);
  my %info; my @tables = qw( gno_name gno_synonym gno_gene gno_variation gno_rearrangement gno_transgene gno_othercomp gno_species gno_remark gno_paper );
  foreach my $table (@tables) { 
    $result = $dbh->prepare( "SELECT * FROM $table WHERE joinkey IN ('$joinkeys');" );
    $result->execute(); while (my @row = $result->fetchrow) { if ($row[1]) { $info{$table}{$row[1]}++; } } }
...
#   $result = $dbh->prepare( "SELECT * FROM obo_data_exprpattern WHERE obo_data_exprpattern ~ 'WBPaper$joinkey' ;" );
  ...
  my %tinpaperlegocc;
  $result = $dbh->prepare( "SELECT tin_paper_legocc FROM tin_paper_legocc WHERE joinkey = '$joinkey' ;" );
  $result->execute(); 
...
sub getAnySpecificIdToValue {			# convert values from postgres values (ids) to what someone types for dataTable display
  ...
  if ($ontology_type eq 'Antibody') {           ($matches, $fieldIdToValue_ref) = &getAnyAntibodyIdToValue($ontology_type, $type, $fieldIdToValue_ref, $userValue); }
  ...
  elsif ($ontology_type eq 'Laboratory') {       ($matches, $fieldIdToValue_ref) = &getAnyLaboratoryIdToValue($ontology_type, $type, $fieldIdToValue_ref, $userValue); }
#   elsif ($ontology_type eq 'Molecule') {         $matches = $userValue; }	# molecule wbid is the ID
  ...
  elsif ($ontology_type eq 'Papspecies') {       ($matches, $fieldIdToValue_ref) = &getAnyPapspeciesIdToValue($ontology_type, $type, $fieldIdToValue_ref, $userValue); }
...
#   elsif ($ontology_type eq 'WBConstruct') {      $matches = $userValue; }	# construct is the ID
  ...
  elsif ($ontology_type eq 'WBGenotype') {      ($matches, $fieldIdToValue_ref) = &getAnyWBGenotypeIdToValue($ontology_type, $type, $fieldIdToValue_ref, $userValue); }
...
sub getAnyAntibodyIdToValue {			# antibody publicname
  ...
  foreach my $name (@data) {
    ...
    if ($fieldIdToValue{$ontology_type}{$joinkey}) { $results{$joinkey} = $fieldIdToValue{$ontology_type}{$joinkey}; }
      ...
      my $result = $dbh->prepare( "SELECT * FROM abp_publicname WHERE joinkey IN (SELECT joinkey FROM abp_name WHERE abp_name = '$name') ;" );
      $result->execute(); my @row = $result->fetchrow();
      if ($row[1]) { $fieldIdToValue{$ontology_type}{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; 
        ...
        else {       $results{$joinkey} = "\"$name<span style='display: none'>$name</span>\""; }	# antibody could have ids but no publicname
  } }
...
} # sub getAnyAntibodyIdToValue

sub getAnyLaboratoryIdToValue {			# laboratory object names (can be entered as rep name, but returns as self and self)
  my ($ontology_type, $type, $fieldIdToValue_ref, $userValue) = @_;
  my %fieldIdToValue = %$fieldIdToValue_ref;
  $userValue =~ s/\"//g;			# strip doublequotes
  my (@data) = split/,/, $userValue; my %results;
  foreach my $name (@data) {
    $results{$name} = "\"$name<span style='display: none'>$name</span>\""; }
  my $data = join",", sort values %results;	# this always joins even if there's only one value for ontology
  if ( $type eq 'ontology' ) { $data =~ s/^\"//; $data =~ s/\"$//; }	# strip quotes for ontology, keep for multiontology
  return ($data, \%fieldIdToValue);
} # sub getAnyLaboratoryIdToValue
...
sub getAnyMoleculeIdToValue {			# molecule object names (not publicname)
  ...
  foreach my $name (@data) {
    ...
    if ($fieldIdToValue{$ontology_type}{$joinkey}) { $results{$joinkey} = $fieldIdToValue{$ontology_type}{$joinkey}; }
      ...
      my $result = $dbh->prepare( "SELECT * FROM mop_publicname WHERE joinkey IN (SELECT joinkey FROM mop_name WHERE mop_name = '$name') ;" );
      $result->execute(); my @row = $result->fetchrow();
      if ($row[1]) { $fieldIdToValue{$ontology_type}{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; 
                     $results{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; }
        else {       $results{$joinkey} = "\"$name<span style='display: none'>$name</span>\""; }	# in case a molecule has id but no publicname
  } }
  my $data = join",", sort values %results;
  if ( $type eq 'ontology' ) { $data =~ s/^\"//; $data =~ s/\"$//; }	# strip quotes for ontology, keep for multiontology
  return ($data, \%fieldIdToValue);
...
sub getAnyPapspeciesIdToValue {			# names of loci by wbgene id
  my ($ontology_type, $type, $fieldIdToValue_ref, $userValue) = @_; $userValue =~ s/\"//g;
  my %fieldIdToValue = %$fieldIdToValue_ref;
  $userValue =~ s/\"//g;			# strip doublequotes
  my (@data) = split/,/, $userValue; my %results;
  foreach my $id (@data) {
    ...
    if ($fieldIdToValue{$ontology_type}{$joinkey}) { $results{$joinkey} = $fieldIdToValue{$ontology_type}{$joinkey}; }
      ...
      my $value = '';
      my $result = $dbh->prepare( "SELECT * FROM pap_species_index WHERE joinkey = '$id';" );
      $result->execute(); my @row = $result->fetchrow();
      if ($row[1]) { $value = $row[1]; }
      if ($value) { $fieldIdToValue{$ontology_type}{$joinkey} = "\"$value<span style='display: none'>$id</span>\""; 
                    $results{$joinkey} = "\"$value<span style='display: none'>$id</span>\""; } } }
  my $data = join",", sort values %results;
  if ( $type eq 'ontology' ) { $data =~ s/^\"//; $data =~ s/\"$//; }	# strip quotes for ontology, keep for multiontology
  return ($data, \%fieldIdToValue);
} # sub getAnyPapspeciesIdToValue

sub getAnyTransgeneIdToValue {			# transgene publicname
  my ($ontology_type, $type, $fieldIdToValue_ref, $userValue) = @_;
  my %fieldIdToValue = %$fieldIdToValue_ref;
  $userValue =~ s/\"//g;			# strip doublequotes
  my (@data) = split/,/, $userValue; my %results;
  foreach my $name (@data) {
    ...
    if ($fieldIdToValue{$ontology_type}{$joinkey}) { $results{$joinkey} = $fieldIdToValue{$ontology_type}{$joinkey}; }
      ...
      my $result = $dbh->prepare( "SELECT * FROM trp_publicname WHERE joinkey IN (SELECT joinkey FROM trp_name WHERE trp_name = '$name') ;" );
      $result->execute(); my @row = $result->fetchrow();
      if ($row[1]) { $fieldIdToValue{$ontology_type}{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; 
                     $results{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; }
        else {       $results{$joinkey} = "\"$name<span style='display: none'>$name</span>\""; }	# some transgenes have ids but no publicname
  } }
  my $data = join",", sort values %results;
  if ( $type eq 'ontology' ) { $data =~ s/^\"//; $data =~ s/\"$//; }	# strip quotes for ontology, keep for multiontology
  return ($data, \%fieldIdToValue);
...
sub getAnyWBGenotypeIdToValue {			# names of loci by wbgene id
  my ($ontology_type, $type, $fieldIdToValue_ref, $userValue) = @_;
  my %fieldIdToValue = %$fieldIdToValue_ref;
  $userValue =~ s/\"//g;			# strip doublequotes
  my (@data) = split/,/, $userValue; my %results;
  foreach my $name (@data) {
    ...
    if ($fieldIdToValue{$ontology_type}{$joinkey}) { $results{$joinkey} = $fieldIdToValue{$ontology_type}{$joinkey}; }
      ...
      my $result = $dbh->prepare( "SELECT * FROM gno_name WHERE joinkey IN (SELECT joinkey FROM gno_identifier WHERE gno_identifier = '$name') ;" );
      $result->execute(); my @row = $result->fetchrow();
      if ($row[1]) { $fieldIdToValue{$ontology_type}{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; 
                     $results{$joinkey} = "\"$row[1]<span style='display: none'>$name</span>\""; } } }
  my $data = join",", sort values %results;	# this always joins even if there's only one value for ontology
...
#   $curator_list{"two13088"} = 'Uhma Ganesan';
  ...
  $curator_list{"two42118"} = 'Marie-Claire Harrison';
  $curator_list{"two40194"} = 'April Jauhal';
  $curator_list{"two12884"} = 'Snehalata Kadam';
  $curator_list{"two324"}   = 'Ranjana Kishore';
  $curator_list{"two363"}   = 'Raymond Lee';
  $curator_list{"two38202"} = 'Shayda Maher';
...
#   $curator_list{"two627"}   = 'Theresa Stiernagle';
  ...
  my $datatype_list_size = scalar keys %$datatype_list_href;

  print qq(<td valign="top">Data Type<br /><select name="datatype" size="$datatype_list_size">\n);
  foreach my $threecode (keys %$datatype_list_href) { print qq(<option value="$threecode">$$datatype_list_href{$threecode}</option>\n); }
  print qq(</select></td>\n);
