...
my $filesPath = $ENV{CALTECH_CURATION_FILES_INTERNAL_PATH} . '/priv/forms/gene_go_curation_status/';
...
#   my $zipfile = 'data/wb.gpad.gz';
  my $filename = 'wb.gpad';
#   my $zipfile = '/usr/caltech_curation_files/priv/forms/gene_go_curation_status/wb.gpad.gz';
  my $zipfile = $filesPath . $filename . '.gz';
  getstore($url, $zipfile);
#   my $file = 'data/wb.gpad';
  my $file = $filesPath . $filename;
...
#   my $zipfile = 'data/c_elegans.PRJNA13758.current_development.gene_product_info.gpi.gz';
  my $filename = 'c_elegans.PRJNA13758.current_development.gene_product_info.gpi';
  my $zipfile = $filesPath . $filename . '.gz';
  getstore($url, $zipfile);
